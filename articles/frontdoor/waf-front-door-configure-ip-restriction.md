...
Use o [New-AzFrontDoorWafMatchConditionObject](/powershell/module/az.frontdoor/new-azfrontdoorwafmatchconditionobject) comando para definir uma condição de correspondência IP. No exemplo abaixo, substitua *ip-endereço de-intervalo de-1*, *ip-endereço de-intervalo de-2* com seu próprio intervalo.
...
Encontre o nome do grupo de recursos que contém o perfil de Front Door usando `Get-AzResourceGroup`. Em seguida, configure uma política de WAF com a regra de bloco IP usando [New-AzFrontDoorWafPolicy](/powershell/module/az.frontdoor/new-azfrontdoorwafpolicy).
