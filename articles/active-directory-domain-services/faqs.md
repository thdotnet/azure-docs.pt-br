...
Redes virtuais clássicas não têm mais suporte para novas implantações. Domínios gerenciados existentes implantados em redes virtuais clássicas continuam a ter suporte.
...
Nº Depois de criar um Azure AD Domain Services domínio gerenciado, você não poderá mover a instância para um grupo de recursos diferente, rede virtual, assinatura, etc. Tome cuidado para selecionar a assinatura, o grupo de recursos, a região e a rede virtual mais apropriados ao implantar a instância de AD DS do Azure.
...
Nº Os Serviços de Domínio do Azure AD é um serviço pré-pago do Azure e não faz parte do EMS. Azure AD Domain Services pode ser usado com todas as edições do Azure AD (gratuito e Premium). Você será cobrado por hora, dependendo do uso.
