...
ms.locfileid: "67807077"
---
# <a name="status-monitor-v2-api-set-applicationinsightsmonitoringconfig-v040-alpha"></a>API de v2 do Monitor de status: Set-ApplicationInsightsMonitoringConfig (v0.4.0-alpha)
