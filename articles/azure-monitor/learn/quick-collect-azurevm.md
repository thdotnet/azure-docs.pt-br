...
2. Selecione o bloco **Pesquisa de Logs** e, no painel Pesquisa de Logs, no campo de consulta, digite `Perf`. Em seguida, pressione Enter ou selecione o botão Pesquisar à direita do campo de consulta.
