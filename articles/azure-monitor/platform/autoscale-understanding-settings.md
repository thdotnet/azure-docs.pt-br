...
| profile | regras | A Autoescala dimensiona automaticamente entre as capacidades máximas e mínimas usando as regras do perfil. Pode haver várias regras em um perfil. Normalmente há duas regras: uma para determinar quando escalar horizontalmente e outra para determinar quando reduzir horizontalmente. |
