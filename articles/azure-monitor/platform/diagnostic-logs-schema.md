...
| resourceId | Necessário | A ID do recurso que emitiu o evento. Para serviços de locatário, isso é o /tenants/tenant-id/providers/provider-name do formulário. |
...
| Recovery Services | [Modelo de dados para os Backup do Azure](../../backup/backup-azure-reports-data-model.md)|
...
|Microsoft.CognitiveServices/accounts|Auditar|Logs de Auditoria|
...
|Microsoft.DataLakeAnalytics/accounts|Auditar|Logs de Auditoria|
|Microsoft.DataLakeAnalytics/accounts|Solicitações|Logs de solicitação|
|Microsoft.DataLakeStore/accounts|Auditar|Logs de Auditoria|
...
|Microsoft.IoTSpaces/Graph|Auditar|Auditar|
...
|Microsoft.Sql/servers/databases|Tempos limites|Tempos limites|
|Microsoft.Sql/servers/databases|Bloqueios|Bloqueios|
|Microsoft.Sql/servers/databases|Deadlocks|Deadlocks|
|Microsoft.Sql/servers/databases|Auditar|Logs de Auditoria|
