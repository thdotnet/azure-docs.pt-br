...
Use a seguinte consulta para mostrar o tempo de ingestão de computador por país/região que estão localizados em que se baseia no seu endereço IP: 
