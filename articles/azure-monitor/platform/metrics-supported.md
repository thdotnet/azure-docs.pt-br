...
|CurrentUserSessions|Sessões de usuário atuais|Contagem|Average|Número atual de sessões de usuário estabelecidas.|ServerResourceType|
|QueryPoolBusyThreads|Threads ocupados do pool de consulta|Contagem|Average|Número de threads ocupados no pool de threads de consulta.|ServerResourceType|
...
|CurrentConnections|Conexão: Conexões atuais|Contagem|Average|Número atual de conexões de cliente estabelecidas.|ServerResourceType|
...
|ProcessingPoolBusyIOJobThreads|Threads: Threads de trabalho de E/S ocupados do pool de processamento|Contagem|Average|Número de threads que executam trabalhos de E/S no pool de threads de processamento.|ServerResourceType|
...
|QueryPoolIdleThreads|Threads: Threads ociosos do pool de consultas|Contagem|Average|Número de threads ociosos para trabalhos de E/S no pool de threads de processamento.|ServerResourceType|
|QueryPoolJobQueueLength|Threads: Tamanho da fila de trabalhos do pool consultas|Contagem|Average|Número de trabalhos na fila do pool de threads de consulta.|ServerResourceType|
...
|mashup_engine_qpu_metric|QPU do mecanismo M|Contagem|Average|Uso de QPU por processos de mecanismo de mashup|ServerResourceType|
...
|OtherRequests|Outras solicitações de gateway|Contagem|Total|O número total de solicitações de gateway em um determinado período que não se enquadram nas categorias bem-sucedidas, não autorizadas ou com falha. Essa métrica foi preterida, é recomendável usar a `Requests` nova métrica. |Local, Nome do host|
...
|Créditos de CPU Consumidos|Créditos de CPU Consumidos|Contagem|Average|Número total de créditos consumido pela Máquina Virtual|Sem dimensões|
...
|Os Por QD de Disco|Disco do so QD (preterido)|Contagem|Average|Profundidade da Fila do Disco do SO (ou Tamanho da Fila)|Sem dimensões|
...
|Profundidade da Fila de Disco do SO|Profundidade da fila de disco do so (visualização)|Contagem|Average|Profundidade da Fila do Disco do SO (ou Tamanho da Fila)|Sem dimensões|
...
|Fluxos de Saída|Fluxos de saída (visualização)|Contagem|Average|Fluxos de saída são o número de fluxos atuais na direção de saída (tráfego saindo da VM)|Sem dimensões|
...
|Profundidade da Fila de Disco de Dados|Profundidade da fila do disco de dados (visualização)|Contagem|Average|Profundidade da Fila do Disco de Dados (ou Tamanho da Fila)|LUN, VMName|
...
|Profundidade da Fila de Disco do SO|Profundidade da fila de disco do so (visualização)|Contagem|Average|Profundidade da Fila do Disco do SO (ou Tamanho da Fila)|VMName|
|Fluxos de Entrada|Fluxos de entrada (visualização)|Contagem|Average|Os fluxos de entrada são o número de fluxos atuais na direção de entrada (tráfego entrando na VM)|VMName|
|Fluxos de Saída|Fluxos de saída (visualização)|Contagem|Average|Fluxos de saída são o número de fluxos atuais na direção de saída (tráfego saindo da VM)|VMName|
...
|Métrica|Nome de exibição da métrica|Unidade|Tipo de agregação|DESCRIÇÃO|Dimensões|
|---|---|---|---|---|---|
|CpuUsage|Uso da CPU|Contagem|Average|Uso de CPU em todos os núcleos em milicores.|containerName|
...
|DCIProfilesCount|Contagem de Instâncias do Perfil|Contagem|Last||Sem dimensões|
...
|DCISegmentsCount|Contagem de Segmentos|Contagem|Last||Sem dimensões|
...
|seconds_behind_master|Retardo de replicação em segundos|Contagem|Average|Retardo de replicação em segundos|Sem dimensões|
...
|connectedDeviceCount|Dispositivos conectados (versão prévia)|Contagem|Average|Número de dispositivos registrados ao seu hub IoT|Sem dimensões|
...
|ConnectionsOpened|Conexões Abertas.|Contagem|Average|Conexões Abertas para o Microsoft.EventHub.|EntityName|
...
|ConnectionsOpened|Conexões Abertas. (Visualização)|Contagem|Average|Conexões Abertas para o Microsoft.EventHub. (Visualização)|Sem dimensões|
|ConnectionsClosed|Conexões Fechadas. (Visualização)|Contagem|Average|Conexões Fechadas para o Microsoft.EventHub. (Visualização)|Sem dimensões|
...
|Métrica|Nome de exibição da métrica|Unidade|Tipo de agregação|DESCRIÇÃO|Dimensões|
|---|---|---|---|---|---|
|ObservedMetricValue|Valor de Métrica Observado|Contagem|Average|O valor calculado pelo dimensionamento automático quando executado|MetricTriggerSource|
...
|ObservedCapacity|Capacidade Observada|Contagem|Average|A capacidade relatada para o dimensionamento automático quando ele foi executado.|Sem dimensões|
...
|RunSuccessLatency|Latência de execução bem sucedida|Segundos|Average|Latência de execuções de fluxo de trabalho bem sucedidas.|Sem dimensões|
|RunThrottledEvents|Eventos de restrição de execução|Contagem|Total|Número de eventos de restrição de ações ou gatilhos de fluxo de trabalho.|Sem dimensões|
|RunStartThrottledEvents|Executar Eventos Limitados por Início|Contagem|Total|Número de eventos restritos de início de fluxo de trabalho.|Sem dimensões|
|RunFailurePercentage|Porcentagem de falha de execução|Percent|Total|Porcentagem de execuções do fluxo de trabalho com falha.|Sem dimensões|
|ActionsStarted|Ações iniciadas |Contagem|Total|Número de ações de fluxo de trabalho iniciadas.|Sem dimensões|
|ActionsCompleted|Ações concluídas |Contagem|Total|Número de ações de fluxo de trabalho concluídas.|Sem dimensões|
|ActionsSucceeded|Ações bem sucedidas |Contagem|Total|Número de ações de fluxo de trabalho bem sucedidas.|Sem dimensões|
...
|DipAvailability|Status de investigação de integridade|Contagem|Average|Status médio de investigação de integridade do Balanceador de Carga por duração de tempo|ProtocolType, BackendPort, FrontendIPAddress, FrontendPort, BackendIPAddress|
...
|HealthyHostCount|Contagem de hosts íntegros|Contagem|Average|Número de hosts de back-end íntegros|BackendSettingsPool|
...
|Average_% Used Inodes|% de Inodes Usados|Contagem|Average|Average_% Used Inodes|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Disk Read Bytes/sec|Bytes/s Lidos em Disco|Contagem|Average|Average_Disk Read Bytes/sec|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Logical Disk Bytes/sec|Bytes de Disco Lógico/s|Contagem|Average|Average_Logical Disk Bytes/sec|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_% Available Memory|% de Memória Disponível|Contagem|Average|Average_% Available Memory|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Total Bytes Transmitted|Total de Bytes Transmitidos|Contagem|Average|Average_Total Bytes Transmitted|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Total Packets Transmitted|Total de Pacotes Transmitidos|Contagem|Average|Average_Total Packets Transmitted|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Total Collisions|Total de Colisões|Contagem|Average|Average_Total Collisions|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Pct User Time|% de Tempo do Usuário|Contagem|Average|Average_Pct User Time|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_Used Memory kBytes|KBytes de Memória Usada|Contagem|Average|Average_Used Memory kBytes|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_Virtual Shared Memory|Memória Virtual Compartilhada|Contagem|Average|Average_Virtual Shared Memory|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_% Interrupt Time|% de Tempo de Interrupção|Contagem|Average|Average_% Interrupt Time|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_% IO Wait Time|% de Tempo de Espera de E/S|Contagem|Average|Average_% IO Wait Time|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_% Privileged Time|% de Tempo Privilegiado|Contagem|Average|Average_% Privileged Time|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_% User Time|% de Tempo do Usuário|Contagem|Average|Average_% User Time|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_Free Physical Memory|Memória Física Livre|Contagem|Average|Average_Free Physical Memory|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_Free Space in Paging Files|Espaço Livre em Arquivos de Paginação|Contagem|Average|Average_Free Space in Paging Files|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Processes|Processos|Contagem|Average|Average_Processes|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Users|Usuários|Contagem|Average|Average_Users|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_Avg. de segundos/Leitura do Disco|Média de segundos/Leitura do Disco|Contagem|Average|Average_Avg. de segundos/Leitura do Disco|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
|Average_Avg. de segundos/Gravação do Disco|Média de segundos/Gravação do Disco|Contagem|Average|Average_Avg. de segundos/Gravação do Disco|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Average_Bytes Sent/sec|Bytes Enviados/s|Contagem|Average|Average_Bytes Sent/sec|Computer, ObjectName, InstanceName, CounterPath, SourceSystem|
...
|Atualizar|Atualizar|Contagem|Average|Atualizar|Computer, Product, Classification, UpdateState, Optional, Approved|
|Evento|Evento|Contagem|Average|Evento|Source, EventLog, Computer, EventCategory, EventLevel, EventLevelName, EventID|
...
|Mensagens|Contagem de mensagens em uma fila/tópico. (Visualização)|Contagem|Average|Contagem de mensagens em uma fila/tópico. (Visualização)|EntityName|
...
|ScheduledMessages|Contagem de mensagens agendadas em uma fila/tópico. (Visualização)|Contagem|Average|Contagem de mensagens agendadas em uma fila/tópico. (Visualização)|EntityName|
...
|ServiceStatus|ServiceStatus|Contagem|Average|Status de integridade de um serviço no aplicativo de malha Service Fabric|ApplicationName, status, ServiceName|
|ServiceReplicaStatus|ServiceReplicaStatus|Contagem|Average|Status de integridade de uma réplica de serviço no aplicativo de malha Service Fabric|ApplicationName, status, ServiceName, nome de réplica|
|ContainerStatus|ContainerStatus|Contagem|Average|Status do contêiner no aplicativo de malha Service Fabric|ApplicationName, ServiceName, CodePackageName, ServiceId, status|
|RestartCount|RestartCount|Contagem|Average|Reiniciar a contagem de um contêiner no aplicativo de malha Service Fabric|ApplicationName, status, ServiceName, nome de réplica, CodePackageName|
...
|dtu_consumption_percent|Porcentagem de DTU|Percent|Average|Porcentagem de DTU. Aplica-se a bancos de dados baseados em DTU.|Sem dimensões|
...
|dtu_limit|Limite de DTU|Contagem|Average|Limite de DTU. Aplica-se a bancos de dados baseados em DTU.|Sem dimensões|
|dtu_used|DTU usado|Contagem|Average|DTU usado. Aplica-se a bancos de dados baseados em DTU.|Sem dimensões|
...
|app_cpu_billed|CPU de aplicativo cobrado|Contagem|Total|CPU do aplicativo cobrada. Aplica-se a bancos de dados sem servidor.|Sem dimensões|
...
|dtu_consumption_percent|Porcentagem de DTU|Percent|Average|Porcentagem de DTU. Aplica-se a pools elásticos baseados em DTU.|Sem dimensões|
...
|storage_limit|Tamanho máximo dos dados|Bytes|Average|Limite de armazenamento|Sem dimensões|
|eDTU_used|eDTU usado|Contagem|Average|eDTU usado. Aplica-se a pools elásticos baseados em DTU.|Sem dimensões|
...
|cpu_used|CPU usada|Contagem|Average|CPU usada. Aplica-se a pools elásticos baseados em vCore.|Sem dimensões|
...
|storage_space_used_mb|Espaço de armazenamento usado|Contagem|Average|Espaço de armazenamento usado|Sem dimensões|
...
|BlobCount|Contagem de Blobs|Contagem|Total|O número de Blobs no serviço Blob da conta de armazenamento.|BlobType|       |BlobCount|Contagem de Blobs|Contagem|Average|O número de Blobs no serviço Blob da conta de armazenamento.|BlobType, camada|
...
|FileCount|Contagem de Arquivos|Contagem|Average|O número de arquivos no serviço Arquivo da conta de armazenamento.|Sem dimensões|
|FileShareCount|Contagem de Compartilhamentos de Arquivos|Contagem|Average|O número de compartilhamentos de arquivos no serviço Arquivo da conta de armazenamento.|Sem dimensões|
|Transações|Transações|Contagem|Total|O número de solicitações feitas a um serviço de armazenamento ou à operação de API especificada. Esse número inclui solicitações bem-sucedidas e com falha, bem como solicitações que produziram erros. Use a dimensão ResponseType para obter o número de tipo diferente de resposta.|ResponseType, GeoType, ApiName, Authentication|
|Entrada|Entrada|Bytes|Total|A quantidade de dados de entrada, em bytes. Esse número inclui a entrada de um cliente externo no Armazenamento do Azure, bem como a entrada no Azure.|GeoType, ApiName, Authentication|
|Saída|Saída|Bytes|Total|A quantidade de dados de saída, em bytes. Esse número inclui a saída de um cliente externo no Armazenamento do Azure, bem como a saída no Azure. Como resultado, esse número não reflete a saída faturável.|GeoType, ApiName, Authentication|
|SuccessServerLatency|Latência de Servidor Com Sucesso|Milissegundos|Média|A latência média usada pelo Armazenamento do Azure para processar uma solicitação bem-sucedida, em milissegundos. Esse valor não inclui a latência de rede especificada em AverageE2ELatency.|GeoType, ApiName, Authentication|
...
|Métrica|Nome de exibição da métrica|Unidade|Tipo de agregação|DESCRIÇÃO|Dimensões|
|---|---|---|---|---|---|
|ServerSyncSessionResult|Resultado da sessão de sincronização|Contagem|Average|Métrica que registra um valor de 1 cada vez que o ponto de extremidade do servidor conclui com êxito uma sessão de sincronização com o ponto de extremidade de nuvem|SyncGroupName, ServerEndpointName, SyncDirection|
...
|DiskQueueLength|Tamanho da fila do disco|Contagem|Average|Tamanho da fila do disco|Instância|
|HttpQueueLength|Tamanho da Fila de Http|Contagem|Average|Tamanho da Fila de Http|Instância|
...
|Métrica|Nome de exibição da métrica|Unidade|Tipo de agregação|DESCRIÇÃO|Dimensões|
|---|---|---|---|---|---|
|WorkersTotal|Total de funções de trabalho|Contagem|Average|Total de funções de trabalho|Sem dimensões|
|WorkersAvailable|Funções de trabalho disponíveis|Contagem|Average|Funções de trabalho disponíveis|Sem dimensões|
|WorkersUsed|Funções de trabalho usadas|Contagem|Average|Funções de trabalho usadas|Sem dimensões|
|CpuPercentage|Percentual de CPU|Percent|Average|Percentual de CPU|Instância|
|MemoryPercentage|Porcentagem de Memória|Percent|Average|Porcentagem de Memória|Instância|
