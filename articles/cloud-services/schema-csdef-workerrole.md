...
| --------- | ---- | ----------- |
|name|cadeia de caracteres|Obrigatório. O nome da função de trabalho. O nome da função deve ser exclusivo.|
...
|protocol|cadeia de caracteres|Obrigatório. O protocolo de transporte para o ponto de extremidade externo. Para uma função de trabalho, os valores possíveis são `HTTP`, `HTTPS`, `UDP` ou `TCP`.|
