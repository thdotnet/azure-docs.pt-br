...
>[!Note]
>O [FAQ de serviços de nuvem - configuração e gerenciamento](cloud-services-configuration-and-management-faq.md) artigo tem algumas informações úteis sobre certificados.
