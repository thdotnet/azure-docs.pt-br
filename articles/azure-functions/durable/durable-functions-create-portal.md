...
> [!NOTE]
> 
> * Se você estiver desenvolvendo funções duráveis em C#, em vez disso, você deve considerar [desenvolvimento do Visual Studio de 2019](durable-functions-create-first-csharp.md).
