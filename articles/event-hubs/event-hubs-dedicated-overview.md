...
A experiência de autoatendimento para [criar um cluster de Hubs de eventos](event-hubs-dedicated-cluster-create-portal.md) por meio de [Portal do Azure](https://aka.ms/eventhubsclusterquickstart) agora está em visualização. Se você tiver alguma dúvida ou precisa de ajuda integração para Hubs de eventos dedicados, entre em contato com o [equipe de Hubs de eventos](mailto:askeventhubs@microsoft.com).
...
Não suportamos um processo de migração automatizada para migrar seus dados de hubs de eventos de um namespace padrão para um dedicado um. 

## <a name="next-steps"></a>Próximas etapas

Entre em contato com seu representante de vendas da Microsoft ou com o Microsoft Support para obter detalhes adicionais sobre Hubs de eventos dedicados. Você também pode criar um cluster ou saber mais sobre Hubs de eventos, tipos de preço visitando os links a seguir:
