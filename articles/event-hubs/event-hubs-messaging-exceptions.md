...
ms.locfileid: "71309838"
---
# <a name="event-hubs-messaging-exceptions---net"></a>Exceções de mensagens dos hubs de eventos-.NET

Este artigo lista algumas das exceções .NET geradas pela biblioteca de API .NET do sistema de mensagens do barramento de serviço do Azure, que inclui .NET Framework APIs de hubs de eventos. Essa referência está sujeita a alterações, então verifique se há atualizações.
