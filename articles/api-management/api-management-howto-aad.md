...
17. Sob **Manage**, selecione **autenticação** e, em seguida, selecione **tokens de ID** sob **concessão implícita**
18. Volte para sua instância de gerenciamento de API, cole o segredo para o **segredo do cliente** caixa.
