...
> [!CAUTION]
> Devido à natureza distribuída de limitação de arquitetura, a limitação de taxa nunca é completamente precisa. A diferença entre configurado e o número real de permitidas solicitações variam com base no volume de solicitações e a taxa, a latência de back-end e outros fatores.
