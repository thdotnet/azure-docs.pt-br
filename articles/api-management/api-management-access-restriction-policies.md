...
| header-name                     | O nome do cabeçalho HTTP contendo o token.                                                                                                                                                                                                                                                                                                                                                                                                         | `header-name` Umou`token-value`deveserespecificado. `query-parameter-name` | N/D                                                                               |
| nome do parâmetro de consulta            | O nome do parâmetro de consulta que contém o token.                                                                                                                                                                                                                                                                                                                                                                                                     | `header-name` Umou`token-value`deveserespecificado. `query-parameter-name` | N/D                                                                               |
| valor do token                     | Expressão que retorna uma cadeia de caracteres que contém o token JWT                                                                                                                                                                                                                                                                                                                                                                                                     | `header-name` Umou`token-value`deveserespecificado. `query-parameter-name` | N/D                                                                               |
