...
1. Provisionar novos dispositivos IoT Edge, um dispositivo com um sistema operacional de geração de imagens e instalar [tempo de execução do IoT Edge](iot-edge-runtime.md).
