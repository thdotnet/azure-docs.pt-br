...
Ver [zonas de disponibilidade](../availability-zones/az-overview.md#services-support-by-region) para obter a lista mais recente de regiões disponíveis.
