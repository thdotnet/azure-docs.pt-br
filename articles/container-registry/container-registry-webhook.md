...
| Location | Para um  [registro replicado geograficamente](container-registry-geo-replication.md), especifique a região do Azure da réplica de registro. 
