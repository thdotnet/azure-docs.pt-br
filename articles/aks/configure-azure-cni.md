...
Os clusters kubernetes criados com o mecanismo AKs dão suporte aos plug-ins [kubenet][kubenet] and [Azure CNI][cni-networking] . Desse modo, há suporte para os dois cenários de rede no Mecanismo do AKS.
