...
O exemplo a seguir cria uma máquina virtual denominada *myVM* na *myResourceGroup* grupo de recursos. Substitua *SUBNET_ID $* com a ID da sub-rede usada pelo seu pool de nós do Windows Server.
