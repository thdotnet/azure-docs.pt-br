...
2. [Anexar o disco do sistema para uma VM de recuperação](troubleshoot-recovery-disks-portal-windows.md). Para executar o [gerenciar-bde](https://docs.microsoft.com/windows-server/administration/windows-commands/manage-bde) comando na etapa 7, o **BitLocker Drive Encryption** recurso deve ser habilitado na VM de recuperação.
...
7.  Para desbloquear o disco anexado, usando o arquivo BEK, execute o comando a seguir.
    ...
    - Se o disco foi desbloqueado com êxito usando a chave BEK. podemos considerar o problema de disco BitLocker ser resolvido. 
