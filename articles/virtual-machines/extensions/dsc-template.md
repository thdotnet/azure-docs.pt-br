...
| settings.configurationArguments |Collection |Define os parâmetros que você deseja passar para a configuração de DSC. Essa propriedade não é criptografada. |
