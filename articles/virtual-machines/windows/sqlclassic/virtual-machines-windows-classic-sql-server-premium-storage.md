...
#### <a name="step-3-addition-ip-address-resource-for-cluster-group-optional"></a>Etapa 3: O recurso de endereço IP de adição \<para o grupo de cluster opcional >
