---
title: Desempenho de tamanho da VM série HC - máquinas virtuais do Azure | Microsoft Docs
description: Saiba mais sobre o desempenho, resultados do teste para tamanhos de VM série HC no Azure.
...
ms.locfileid: "66809851"
---
# <a name="hc-series-virtual-machine-sizes"></a>Tamanhos de máquina virtual da série HC

Vários testes de desempenho foram executados em tamanhos de HC-series. A seguir estão alguns dos resultados desse teste de desempenho.
...
| Largura de banda e latência RDMA                        | 1,80 microssegundos, 96.3 Gb/s   |
| FIO em NVMe SSD local                           | Leituras de GB/s ~1.3, ~ 900 MB/s grava |  
| IOR no Premium do Azure 4 SSD (P30 Managed Disks, RAID0) * *  | ~ 780 MB/s ~ 780 MB, leituras/gravações |
...
| #bytes  | Latência [microssegundo] (MPICH 3.3 + Capítulo 4) | Latência [microssegundo] (OpenMPI 4.0.0) | Latência [microssegundo] (MVAPICH2 2.3) |
|------|----------|----------|----------|
| 2    | 1.84     | 1.78     | 2.08     |
| 4    | 1.84     | 1.79     | 2.08     |
| 8    | 1.85     | 1.79     | 2.05     |
