...
Esse processo pode ter desabilitado o acesso público ao serviço. Para habilitar o acesso público, você pode atualizar o [valor de entrada em *values.yaml*][ingress-update].
