---
title: Exibir documentos de imposto para o seu cliente Microsoft contrato - Azure | Microsoft Docs
description: Saiba como exibir e baixar os recebimentos de imposto para o seu perfil de cobrança do contrato do cliente Microsoft.
services: ''
documentationcenter: ''
author: jureid
manager: jureid
...
Você deve ser o proprietário, colaborador, leitor ou Gerenciador de faturas do perfil de cobrança para exibir e baixar documentos de imposto. Para saber mais sobre as funções de cobrança para contratos de clientes da Microsoft, consulte [perfil de funções e tarefas de cobrança](billing-understand-mca-roles.md#billing-profile-roles-and-tasks).
...
3. Selecione **Faturas**.
4. Na grade de nota fiscal, localize a linha da fatura correspondente ao documento de impostos que você deseja baixar.
5. Clique nas reticências (`...`) no final da linha.
6. Selecione **documentos de imposto**. Dependendo do país/região do seu perfil de cobrança, você poderá ver mais de um documento de imposto por fatura.
