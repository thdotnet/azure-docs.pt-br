---
title: Alterar seu cartão de crédito do Azure
...
ms.locfileid: "67491303"
---
# <a name="add-update-or-remove-a-credit-card-for-azure"></a>Adicionar, atualizar ou remover um cartão de crédito do Azure

No portal do Azure, você pode adicionar um novo cartão de crédito, atualize um cartão de crédito existente ou excluir um cartão de crédito que você não usa. Você deve ser um [administrador da conta](billing-subscription-transfer.md#whoisaa) para fazer essas alterações.

Se você tiver um [contrato de cliente do Microsoft](#check-access-to-a-microsoft-customer-agreement), seus métodos de pagamento estão associados com perfis de cobrança. Saiba como [alterar o método de pagamento padrão para um perfil de cobrança](#change-payment-method-for-a-billing-profile). Somente o usuário que se inscreveram para o Azure pode atualizar o método de pagamento.

**Deseja mudar para pagar por fatura (transferência de seleção/eletrônica)?** Consulte [Pagar assinaturas do Azure por fatura](billing-how-to-pay-by-invoice.md).
...
1. Selecione a assinatura que você deseja adicionar o cartão de crédito.
...
1. Insira os detalhes de cartão de crédito.
...
1. Atualize os detalhes de cartão de crédito.
1. Clique em **Salvar**.

## <a name="use-a-different-credit-card"></a>Usar um cartão de crédito diferente

Se mais de uma de suas assinaturas têm o mesmo método de pagamento ativo, também, em seguida, alterando o método de pagamento ativo em qualquer uma dessas assinaturas atualiza o método de pagamento ativo nas outras.
...
1. Marque a caixa ao lado do cartão que você gostaria de tornar o método de pagamento ativo.
1. Clique em **definida como ativa**.
    ![Captura de tela que mostra o cartão de crédito selecionada e definida como ativa.](./media/billing-how-to-change-credit-card/sub-change-active-x.png)
...
1. Sob **cobrança**, selecione **métodos de pagamento**.

    ![Captura de tela que mostra a opção Gerenciar formas de pagamento selecionada.](./media/billing-how-to-change-credit-card/payment-methods-blade-x.png)

1. Marque a caixa ao lado do cartão que você deseja remover.
1. Clique em **Excluir**.

Se seu cartão de crédito é o método de pagamento ativo para qualquer uma das suas assinaturas da Microsoft, é possível removê-la da sua conta do Azure. Altere o método de pagamento ativo para todas as assinaturas vinculadas a esse cartão de crédito e tente novamente
...
## <a name="change-payment-method-for-a-billing-profile"></a>Alterar método de pagamento para um perfil de cobrança

Para alterar o método de pagamento para um perfil de cobrança, você deve ser a pessoa que se inscreveram para o Azure.

Se você gostaria de mudar o método de pagamento padrão para seleção/cabo de transferência, saiba como [alternar de um perfil de cobrança para seleção/cabo de transferência](billing-how-to-pay-by-invoice.md).
...
1. Acima do método de pagamento padrão, clique em **alteração**.

    ![Botão de alterar a captura de tela que mostra](./media/billing-how-to-change-credit-card/customer-led-switch-credit-card.png)

1. Selecione um cartão existente ou adicionar um novo.

## <a name="frequently-asked-questions"></a>Perguntas frequentes
As seções a seguir respondem a perguntas frequentes sobre como alterar suas informações de cartão de crédito ou débito.
...
Depois que sua assinatura estiver desabilitada ou cancelada, poderemos esperar 90 dias antes de excluir permanentemente a sua assinatura. Mantemos sua forma de pagamento no arquivo durante o período de retenção caso você deseje reativar a assinatura. Depois disso, a assinatura será excluída permanentemente.

Se você precisar remover seu cartão de crédito antes do período de retenção de 90 dias terminar, [reativar sua assinatura](billing-subscription-become-disable.md). Se não conseguir reativar, [entre em contato com o suporte do Azure](https://portal.azure.com/?#blade/Microsoft_Azure_Support/HelpAndSupportBlade).
...
Se você configurar um cartão de crédito como seu método de pagamento, podemos cobrança no cartão automaticamente após cada período de cobrança. Você não precisa fazer nada.
...
Para adicionar ou atualizar a ID de imposto, atualize seu perfil na [Centro de contas do Azure](https://account.azure.com/Profile), em seguida, selecione **registro fiscal**. Essa ID de imposto é usada para cálculos de isenção de impostos e aparece em sua fatura.
...
- Saiba mais sobre [reservas Azure](billing-save-compute-costs-reservations.md) para ver se eles podem economizar seu dinheiro.
