...
## <a name="add-a-new-credit-or-debit-card-to-an-azure-subscription"></a>Adicionar um novo cartão de crédito ou débito para uma assinatura do Azure
...
1. Clique em **definida como ativa**.
    ![Captura de tela que mostra o cartão de crédito ou débito selecionada e definida como ativa.](./media/billing-how-to-change-credit-card/sub-change-active-x.png)
...
Se seu cartão de crédito é o método de pagamento ativo para qualquer uma das suas assinaturas da Microsoft, é possível removê-la da sua conta do Azure. Altere o método de pagamento ativo para todas as assinaturas vinculadas a esse cartão de crédito ou débito e tente novamente
