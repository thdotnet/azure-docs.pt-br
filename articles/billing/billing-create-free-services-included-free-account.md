...
Recomendamos que você use a [página de serviço gratuito](https://go.microsoft.com/fwlink/?linkid=859151) para criar novos serviços. Ou você pode entrar para o [portal do Azure](https://portal.azure.com), selecione **todos os serviços** à esquerda e procure **serviços gratuitos**.
...
## <a name="create-multiple-service-instances-in-allowed-limits"></a>Criar várias instâncias do serviço em limites permitidos
...
- Saiba como [evite ser cobrado por sua conta gratuita do Azure](billing-avoid-charges-free-account.md).
