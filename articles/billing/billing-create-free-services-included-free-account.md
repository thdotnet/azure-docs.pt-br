...
Recomendamos que você use a [página de serviço gratuito](https://go.microsoft.com/fwlink/?linkid=859151) para criar novos serviços. Ou você pode entrar no [Portal do Azure](https://portal.azure.com), selecionar **Todos os serviços** na parte inferior esquerda e pesquisar em **Serviços gratuitos**. 
