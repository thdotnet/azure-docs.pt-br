...
| carga | Obtém as informações de carga da partição do Service Fabric especificado. |
...
| reiniciar | Essa API reiniciará algumas ou todas as réplicas ou instâncias da partição especificada. |
