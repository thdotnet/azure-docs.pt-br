---
title: Amostra de script da CLI do Azure – Conectar um aplicativo a uma conta de armazenamento | Microsoft Docs
description: Amostra de script da CLI do Azure – Conectar um aplicativo a uma conta de armazenamento
services: appservice
