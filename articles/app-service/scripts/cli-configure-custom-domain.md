---
title: Exemplo de Script CLI do Azure – Mapear um domínio personalizado para um aplicativo | Microsoft Docs
description: Exemplo de Script CLI do Azure – Mapear um domínio personalizado para um aplicativo
