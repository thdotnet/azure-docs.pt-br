---
title: Amostra de script da CLI do Azure – Conectar um aplicativo ao MongoDB (Cosmos DB) | Microsoft Docs
description: Amostra de script da CLI do Azure – Conectar um aplicativo ao MongoDB (Cosmos DB)
services: appservice
