...
## <a name="step-1-connect-your-f5-appliance-using-an-agent"></a>Etapa 1: Conectar seu dispositivo F5 usando um agente
...
## <a name="step-2-forward-f5-logs-to-the-syslog-agent"></a>Etapa 2: Encaminhar os logs F5 para o agente de syslog
