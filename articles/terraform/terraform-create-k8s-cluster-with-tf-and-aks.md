...
Neste tutorial, você aprenderá como executar as seguintes tarefas ao criar um cluster [ Kubernetes ](https://www.redhat.com/en/topics/containers/what-is-kubernetes) usando [ Terraform ](https://terraform.io) e AKS:
