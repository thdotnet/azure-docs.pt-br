...
2. Abra *Function1.cs* e adicione uma referência ao provedor de configuração geral do .NET Core e ao provedor de Configuração de Aplicativos do .NET Core.
