...
5. No diálogo Adicionar Driver, adicione as informações a seguir:
    ...
    * **Caminho da classe extra**: Use o **adicionar** botão para adicionar todos os arquivos jar baixados anteriormente
