...
---
# <a name="tutorial-extract-transform-and-load-data-using-apache-hive-in-azure-hdinsight"></a>Tutorial: Extrair, transformar e carregar dados usando o Apache Hive no Azure HDInsight
...
* Um banco de dados SQL do Azure. Você usa um banco de dados SQL do Azure como um repositório de dados de destino. Se você não tiver um Banco de Dados SQL, consulte [Criar um Banco de Dados SQL do Azure no Portal do Azure](../sql-database/sql-database-single-database-get-started.md).
...
Neste tutorial, você pegou um arquivo de dados CSV brutos, importou-o em um armazenamento de cluster do HDInsight e, em seguida, transformou os dados usando o Apache Hive no Azure HDInsight.  Avance para o próximo tutorial para aprender a criar clusters do HDInsight Hadoop sob demanda usando o Azure Data Factory.
...
* [Tutorial: Extrair, transformar e carregar dados usando o Apache Hive no Azure HDInsight](../storage/blobs/data-lake-storage-tutorial-extract-transform-load-hive.md)
* [Usar o Apache Hive com o HDInsight](hadoop/hdinsight-use-hive.md)
* [Desenvolver programas do MapReduce em Java para o Apache Hadoop no HDInsight](hadoop/apache-hadoop-develop-deploy-java-mapreduce-linux.md)

* [Usar o Apache Oozie com o HDInsight](hdinsight-use-oozie-linux-mac.md)
* [Usar o Apache Sqoop com HDInsight](hadoop/apache-hadoop-use-sqoop-mac-linux.md)