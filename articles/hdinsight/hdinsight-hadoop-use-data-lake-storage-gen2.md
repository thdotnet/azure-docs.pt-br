...
Criar uma conta de armazenamento do Azure Data Lake Storage Gen2. Verifique se a opção de **namespace hierárquico** está habilitada. Para obter mais informações, confira [Início Rápido: Criar uma conta de armazenamento do Azure Data Lake Storage Gen2](../storage/blobs/data-lake-storage-quickstart-create-account.md).
...
Atribua a identidade gerenciada à função de **proprietário de dados do blob de armazenamento** na conta de armazenamento. Para obter mais informações, consulte [Gerenciar direitos de acesso para dados de Blob e fila do Azure com RBAC (visualização)](../storage/common/storage-auth-aad-rbac.md).
