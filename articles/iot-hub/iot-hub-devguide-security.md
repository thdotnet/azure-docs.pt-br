...
O [SDK do dispositivo IoT do Azure para .NET](https://github.com/Azure/azure-iot-sdk-csharp/tree/master/device) (versão 1.0.11 ou superior) oferece suporte ao uso de certificados X.509.
