...
|jobs<br>.queryJobs<br>.failure|Consultas de trabalho com falhas|Count|Total|A contagem de todas as chamadas para consultas de trabalho com falhas.|Sem dimensões|
...
|connected<br>DeviceCount|Dispositivos conectados (versão prévia)|Count|Média|Número de dispositivos registrados ao seu hub IoT|Sem dimensões|
