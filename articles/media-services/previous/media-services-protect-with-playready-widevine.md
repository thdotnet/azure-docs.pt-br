...
* [Introdução ao SDK de cliente Java para os serviços de mídia do Azure](https://docs.microsoft.com/azure/media-services/media-services-java-how-to-use)
