...
3. Selecione **métricas**e então **nova regra de alerta**.
...
5. Em **Configurar lógica de sinal**, altere **Nível de Evento** para **Todos** e altere **Status** para **Falha**. Deixe **evento iniciado por** em branco e selecione **feito**.
