...
O Azure Active Directory (Azure AD) Privileged Identity Management (PIM) apresenta novos controles para gerenciar o acesso e o ciclo de vida de atribuição para recursos do Azure. Os administradores podem atribuir associação usando propriedades de data e hora de início e término. Quando a atribuição termina, o PIM envia notificações por e-mail aos usuários ou grupos afetados. Ele também envia notificações por e-mail aos administradores do recurso para garantir que o acesso apropriado seja mantido. As atribuições podem ser renovadas e permanecer visíveis em um estado expirado por até 30 dias, mesmo que o acesso não seja estendido.
...
### <a name="member-extend"></a>Estender membro
...
### <a name="admin-extend"></a>Extensão de administrador
...
### <a name="member-renew"></a>Renovação de membro
...
### <a name="admin-renew"></a>Renovar administrador
