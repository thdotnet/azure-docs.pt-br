...
| [Planos de implantação](../fundamentals/active-directory-deployment-plans.md) | Encontre mais planos de implantação para implantar recursos, como a autenticação multifator, acesso condicional, o provisionamento de usuário, o SSO contínuo, a redefinição de senha de autoatendimento e muito mais! |
