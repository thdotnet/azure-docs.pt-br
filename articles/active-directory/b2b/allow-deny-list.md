...
- Para obter informações sobre o acesso condicional e colaboração B2B, consulte [Acesso condicional para usuários de colaboração B2B](conditional-access.md).
