...
Acesso restrito ao Portal de administração do Azure AD | Definir essa opção como Sim impede que os usuários de acessar o Active Directory do Azure por meio do portal do Azure.
