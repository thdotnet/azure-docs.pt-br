...
> Para entender as diferenças entre os pontos de extremidade v1.0 e v2.0 leia a [guia de comparação de ponto de extremidade](azure-ad-endpoint-comparison.md).
