...
| `homepage` | Cadeia de caracteres | A URL para a página inicial do aplicativo. <br><br> _Observação: Isso está disponível apenas na experiência de registros (herdado) do aplicativo. Substituído por `signInUrl` no [registros do aplicativo](https://go.microsoft.com/fwlink/?linkid=2083908) experiência._ | `"https://MyRegisteredApp"` |
