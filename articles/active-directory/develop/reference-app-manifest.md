...
| `displayName` | String | O nome de exibição do aplicativo. <br><br> _Observação: Isso está disponível apenas na experiência de registros (herdado) do aplicativo. Substituído por `name` no [registros do aplicativo](https://go.microsoft.com/fwlink/?linkid=2083908) experiência._ | `"MyRegisteredApp"` |
...
| `homepage` | String | A URL da home page do aplicativo. <br><br> _Observação: Isso está disponível apenas na experiência de registros (herdado) do aplicativo. Substituído por `signInUrl` no [registros do aplicativo](https://go.microsoft.com/fwlink/?linkid=2083908) experiência._ | `"https://MyRegisteredApp"` |
| `objectId` | String | O identificador exclusivo do aplicativo no diretório. <br><br> _Observação: Isso está disponível apenas na experiência de registros (herdado) do aplicativo. Substituído por `id` no [registros do aplicativo](https://go.microsoft.com/fwlink/?linkid=2083908) experiência._ | `"f7f9acfc-ae0c-4d6c-b489-0a81dc1652dd"` |
...
| `publisherDomain` | String | O domínio verificado do publicador para o aplicativo. Somente leitura. | https://www.contoso.com |
