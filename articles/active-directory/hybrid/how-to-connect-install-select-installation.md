...
O Azure AD Connect oferece dois tipos de instalação para uma nova instalação: expressa e personalizada. Este tópico ajuda você a decidir qual opção usar durante a instalação.
