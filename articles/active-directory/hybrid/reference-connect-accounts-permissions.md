...
| Página do assistente | Credenciais coletadas | Permissões necessárias | Utilizado para |
| --- | --- | --- | --- |
...
| Entidade de segurança | Permissões necessárias | Utilizado para |
| --- | --- | --- |
