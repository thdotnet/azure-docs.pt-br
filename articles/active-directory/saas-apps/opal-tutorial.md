...
* Você pode permitir que os usuários entrem automaticamente no Opal (Logon Único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Opal
...
4. Na caixa de pesquisa, digite **Opal**, selecione **Opal** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
     ...
     ![Opal na lista de resultados](common/search-new-app.png)

## <a name="configure-and-test-azure-ad-single-sign-on"></a>Configurar e testar logon único do Azure AD

Nesta seção, você configurará e testará o logon único do Azure AD com Opal com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Opal.
...
2. **[Configurar o Logon Único do Opal](#configure-opal-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar usuário de teste do Opal](#create-opal-test-user)** – para ter um equivalente de Brenda Fernandes no Opal vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Opal**, selecione **Logon único**.
...
6. Além do indicado acima, o aplicativo Opal espera que mais alguns atributos sejam passados novamente na resposta SAML. Na seção **Declarações de Usuário** da caixa de diálogo **Atributos de Usuário**, execute as seguintes etapas para adicionar o atributo de token SAML, conforme mostrado na tabela abaixo:
...
8. Na seção **Configurar o Opal**, copie as URLs apropriadas de acordo com suas necessidades.
...
### <a name="configure-opal-single-sign-on"></a>Configurar o logon único do Opal
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Opal**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, escolha **Opal**.

    ![O link do Opal na lista de Aplicativos](common/all-applications.png)
