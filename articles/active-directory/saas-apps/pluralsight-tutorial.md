...
* Você pode permitir que os usuários sejam conectados automaticamente ao Pluralsight (Logon Único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Pluralsight
...
Nesta seção, você configurará e testará o logon único do Azure AD com o Pluralsight, com base em um usuário de teste chamado **Brenda Fernandes**.
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Pluralsight.
...
2. **[Configurar o Logon Único do Pluralsight](#configure-pluralsight-single-sign-on)** – para definir as configurações de Logon Único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Pluralsight](#create-pluralsight-test-user)** – para ter um equivalente de Brenda Fernandes no Pluralsight que esteja vinculado à representação de usuário do Azure AD.
...
Para configurar o logon único do Azure AD com o Pluralsight, execute as seguintes etapas:

1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Pluralsight**, selecione **Logon único**.
...
6. Além do indicado acima, o aplicativo Pluralsight espera que mais alguns atributos sejam passados novamente na resposta SAML. Na seção **Declarações de Usuário** da caixa de diálogo **Atributos de Usuário**, execute as seguintes etapas para adicionar o atributo de token SAML, conforme mostrado na tabela abaixo:
...
### <a name="configure-pluralsight-single-sign-on"></a>Configurar o Logon Único do Pluralsight

Para configurar o logon único no lado do **Pluralsight**, é necessário enviar o **XML de Metadados de Federação** baixado no portal do Azure para a [equipe de suporte do Pluralsight](mailto:support@pluralsight.com). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Pluralsight**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, digite e selecione **Pluralsight**.

    ![O link do Pluralsight na Lista de aplicativos](common/all-applications.png)
