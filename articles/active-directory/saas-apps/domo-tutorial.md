...
* Você pode controlar no Azure AD quem terá acesso ao Domo.
* Você pode permitir que os usuários sejam conectados automaticamente ao Domo (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Domo
...
4. Na caixa de pesquisa, digite **Domo**, selecione **Domo** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Domo.
...
2. **[Configurar o logon único do Domo](#configure-domo-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Domo](#create-domo-test-user)** – para ter um equivalente de Brenda Fernandes no Domo que esteja vinculado à representação de usuário do Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Domo**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único de Domínio e URLs do Domo](common/sp-identifier.png)
...
8. Na seção **Configurar o Domo**, copie as URLs apropriadas de acordo com suas necessidades.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Domo**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, escolha **Domo**.

    ![O link do Domo na lista Aplicativos](common/all-applications.png)
...
Nesta seção, um usuário chamado Brenda Fernandes será criado no Domo. O Domo dá suporte ao provisionamento de usuário just-in-time, que está habilitado por padrão. Não há itens de ação para você nesta seção. Se um usuário ainda não existir no Domo, um novo será criado após a autenticação.
