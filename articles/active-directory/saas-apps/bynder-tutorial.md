...
ms.locfileid: "67105920"
---
# <a name="tutorial-azure-active-directory-integration-with-bynder"></a>Tutorial: Integração do Azure Active Directory com o Bynder
...
* Você pode permitir que os usuários sejam conectados automaticamente ao Bynder (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Bynder
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Bynder.
...
2. **[Configurar o logon único do Bynder](#configure-bynder-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Bynder**, selecione **Logon único**.
...
4. Na seção **Configuração básica do SAML**, execute as etapas a seguir caso deseje configurar o aplicativo no modo **IDP** iniciado:
    ...
    ![Informações de logon único de Domínio e URLs do Bynder](common/idp-intiated.png)
...
5. Clique em **Definir URLs adicionais** e execute o passo seguinte se quiser configurar a aplicação no modo **SP** iniciado:
    ...
    ![Informações de logon único de Domínio e URLs do Bynder](common/metadata-upload-additional-signon.png)
...
7. Na seção **Configurar o Bynder**, copie as URLs apropriadas de acordo com suas necessidades.
...
### <a name="configure-bynder-single-sign-on"></a>Configurar o logon único do Bynder

Para configurar o logon único no lado do **Bynder**, é necessário enviar o **XML de Metadados de Federação** baixado e as URLs apropriadas copiadas do portal do Azure para a [equipe de suporte do Bynder](https://www.bynder.com/en/support/). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Bynder**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, escolha **Bynder**.

    ![O link do Bynder na lista de Aplicativos](common/all-applications.png)
