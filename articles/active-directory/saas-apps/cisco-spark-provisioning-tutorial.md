...
1. Entre no [portal do Azure](https://portal.azure.com), selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Cisco Spark**.
...
6. O **ID do Locatário** e o **Token Secreto** para a sua conta do Cisco Spark podem ser encontrados fazendo login no [site do desenvolvedor do Cisco Spark](https://developer.webex.com/) com sua conta de Administrador. Uma vez logado -
   ...
   * Role a página para baixo até a [Seção de Autenticação](https://developer.webex.com/getting-started.html#authentication)
