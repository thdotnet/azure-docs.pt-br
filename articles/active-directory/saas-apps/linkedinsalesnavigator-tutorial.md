...
* No Azure AD, é possível controlar quem tem acesso ao LinkedIn Sales Navigator.
* É possível permitir que seus usuários entrem automaticamente no LinkedIn Sales Navigator (logon único) com suas contas do Azure AD.
...
* Uma assinatura do LinkedIn Sales Navigator habilitada para logon único
...
4. Na caixa de pesquisa, digite **LinkedIn Sales Navigator**, selecione **LinkedIn Sales Navigator** no painel de resultados e, depois, clique no botão **Adicionar** para adicionar o aplicativo.

    ![LinkedIn Sales Navigator na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do LinkedIn Sales Navigator.
...
2. **[Configurar logon único do LinkedIn Sales Navigator](#configure-linkedin-sales-navigator-single-sign-on)** – para configurar as definições de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do LinkedIn Sales Navigator](#create-linkedin-sales-navigator-test-user)** – para ter um equivalente de Brenda Fernandes no LinkedIn Sales Navigator que esteja vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **LinkedIn Sales Navigator**, selecione **Logon único**.
...
5. Clique em **Definir URLs adicionais** e execute o passo seguinte se quiser configurar a aplicação no modo **SP** iniciado:
    ...
    ![Informações de logon único em Domínio e URLs do LinkedIn Sales Navigator](common/metadata-upload-additional-signon.png)
...
9. Na seção **Configurar o LinkedIn Sales Navigator**, copie a URL apropriada de acordo com seus requisitos.
...
### <a name="configure-linkedin-sales-navigator-single-sign-on"></a>Configurar logon único do LinkedIn Sales Navigator
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, escolha **LinkedIn Sales Navigator**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **LinkedIn Sales Navigator**.

    ![O link do LinkedIn Sales Navigator na lista de aplicativos](common/all-applications.png)
