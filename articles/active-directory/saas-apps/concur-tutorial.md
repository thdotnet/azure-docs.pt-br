...
* Você pode permitir que seus usuários entrem automaticamente no Concur (logon único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Concur
...
4. Na caixa de pesquisa, digite **Concur**, selecione **Concur** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![Concur na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Concur.
...
2. **[Configurar o logon único do Concur](#configure-concur-single-sign-on)** – para definir as configurações de logon único no lado do aplicativo.
3. **[Criar um usuário de teste do Azure AD](#create-an-azure-ad-test-user)** – para testar o logon único do Azure AD com Brenda Fernandes.
4. **[Atribuir o usuário de teste do Azure AD](#assign-the-azure-ad-test-user)** – para permitir que Brenda Fernandes use o logon único do Azure AD.
5. **[Criar um usuário de teste do Concur](#create-concur-test-user)** – para ter um equivalente de Brenda Fernandes no Concur que esteja vinculado à representação do usuário no Azure AD.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativo **Concur**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único em Domínio e URLs do Concur](common/sp-identifier.png)
...
6. Na seção **Configurar Concur**, copie a URL apropriada, de acordo com suas necessidades.
...
### <a name="configure-concur-single-sign-on"></a>Configurar Logon Único do Concur

Para configurar o logon único no lado do **Concur** é necessário enviar o **XML de metadados** baixado e as URLs copiadas apropriadas do portal do Azure para a [equipe de suporte do Concur](https://www.concur.co.in/contact). Eles definem essa configuração para ter a conexão de SSO de SAML definida corretamente em ambos os lados.
...
1. No portal do Azure, escolha **Aplicativos Empresariais**, escolha **Todos os aplicativos** e, em seguida, escolha **Concur**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, digite e escolha **Concur**.

    ![O link do Concur na lista de aplicativos](common/all-applications.png)
...
Nesta seção, é criado um usuário chamado Brenda Fernandes no Concur. O Concur dá suporte ao provisionamento Just-In-Time, que está habilitado por padrão. Não há itens de ação para você nesta seção. Se um usuário ainda não existir no Concur, um novo será criado após a autenticação.
