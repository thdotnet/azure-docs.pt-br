...
* Você pode controlar no Azure AD quem terá acesso ao Blackboard Learn.
* Você pode permitir que os usuários sejam conectados automaticamente ao Blackboard Learn (Logon Único) com suas contas do Azure AD.
...
* Assinatura habilitada para logon único do Blackboard Learn
...
4. Na caixa de pesquisa, digite **Blackboard Learn**, selecione **Blackboard Learn** no painel de resultados e, em seguida, clique no botão **Adicionar** para adicionar o aplicativo.

     ![Blackboard Learn na lista de resultados](common/search-new-app.png)
...
Para que o logon único funcione, é necessário estabelecer uma relação de vínculo entre um usuário do Azure AD e o usuário relacionado do Blackboard Learn.
...
1. No [portal do Azure](https://portal.azure.com/), na página de integração de aplicativos do **Blackboard Learn**, selecione **Logon único**.
...
4. Na seção **Configuração básica de SAML**, realize as seguintes etapas:
    ...
    ![Informações de logon único de Domínio e URLs do Blackboard Learn](common/sp-identifier.png)
...
### <a name="configure-blackboard-learn-single-sign-on"></a>Configurar o Logon Único do Blackboard Learn

Para configurar o logon único no lado do **Blackboard Learn**, é necessário enviar o **XML de Metadados de Federação** baixado e o **Identificador do Azure AD** para o [suporte do Blackboard Learn](https://www.blackboard.com/support/index.aspx).
...
1. No portal do Azure, selecione **Aplicativos Empresariais**, **Todos os aplicativos** e, em seguida, **Blackboard Learn**.

    ![Folha de aplicativos empresariais](common/enterprise-applications.png)

2. Na lista de aplicativos, selecione **Blackboard Learn**.

    ![O link do Blackboard Learn na lista Aplicativos](common/all-applications.png)
