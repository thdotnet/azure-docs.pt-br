...
4. Insira o endereço IP, intervalo de endereços IP ou sub-rede deve ser permitido. Se for inserir uma sub-rede, selecione a Máscara de Rede apropriada e clique em **OK**.
