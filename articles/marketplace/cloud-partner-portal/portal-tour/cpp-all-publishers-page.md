...
![Página de todos os publicadores](./media/all-publishers-page1.png)

Clicar na primeira entrada exibirá a página de perfil da Contoso.  Você só pode editar seu próprio perfil de editor.

![Página de perfil do editor da Contoso](./media/all-publishers-page2.png)


## <a name="next-steps"></a>Próximas etapas

O próximo item do menu de navegação exibe uma [Página de usuários](./cpp-users-page.md), que lista todos os usuários registrados. 
