...
| Transação | Contêiner | <table> <tr><th>Vitrines</th></tr> <tr><td>Título (50 caracteres)</td></tr> <tr><td>Resumo (200 caracteres)</td></tr> <tr><td>Resumo longo (256 caracteres)</td></tr> <tr><td>Descrição baseada em HTML (3.000 caracteres)</td></tr> <tr><td>Logotipos da empresa (40 x 40, 90 x 90, 115 x 115, 255 x 115, 815 x 290)</td></tr> </table> <table> <tr><th>SKU</th></tr> <tr><td>Detalhes do repositório de imagem do registro de contêiner (ACR) do Azure: ID da assinatura</td></tr> <tr><td>Detalhes do repositório de imagem ACR: Nome do grupo de recursos</td></tr> <tr><td>Detalhes do repositório de imagem ACR: Nome do registro</td></tr> <tr><td>Detalhes do repositório de imagem ACR: Nome do repositório</td></tr> <tr><td>Detalhes do repositório de imagem ACR: Nome de usuário</td></tr> <tr><td>Detalhes do repositório de imagem ACR: Senha</td></tr> <tr><td>Detalhes do repositório de imagem ACR: Marcas de imagem (opcionais)</td></tr> </table> |  
