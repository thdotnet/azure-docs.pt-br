---
title: Script do PowerShell do Azure – Azure Cosmos DB Criar coleção e banco de dados de API do MongoDB
description: Script do PowerShell do Azure – Azure Cosmos DB Criar coleção e banco de dados de API do MongoDB
author: markjbrown
