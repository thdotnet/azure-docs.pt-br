---
title: Script do PowerShell do Azure – Azure Cosmos DB listar e obter operações para a API do MongoDB
description: Script do PowerShell do Azure – Azure Cosmos DB listar e obter operações para a API do MongoDB
author: markjbrown
...
ms.locfileid: "66247433"
---
# <a name="list-and-get-databases-and-graphs-for-azure-cosmos-db---mongodb-api"></a>Listar e obter bancos de dados e gráficos para o Azure Cosmos DB – API do MongoDB
