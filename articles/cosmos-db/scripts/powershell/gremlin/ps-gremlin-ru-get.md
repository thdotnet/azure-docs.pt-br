---
title: Script do PowerShell do Azure – Azure Cosmos DB obter taxa de transferência (RU/s) para a API do Gremlin
description: Script do PowerShell do Azure – Azure Cosmos DB obter taxa de transferência (RU/s) para a API do Gremlin
author: markjbrown
...
ms.locfileid: "67566837"
---
# <a name="get-throughput-rus-for-a-database-or-graph-for-azure-cosmos-db---gremlin-api"></a>Obter a taxa de transferência (RU/s) para um banco de dados ou um gráfico para o Azure Cosmos DB – API do Gremlin
