---
title: Script do PowerShell do Azure – Azure Cosmos DB listar e obter as operações de API de tabela
description: Script do PowerShell do Azure – Azure Cosmos DB listar e obter as operações de API de tabela
author: markjbrown
