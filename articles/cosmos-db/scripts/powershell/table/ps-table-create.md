---
title: Script do PowerShell do Azure – Azure Cosmos DB criar tabela de API de tabela
description: Script do PowerShell do Azure – Azure Cosmos DB criar tabela de API de tabela
author: markjbrown
