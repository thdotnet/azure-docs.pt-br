---
title: Script do PowerShell do Azure – Azure Cosmos DB criar tabela e a API do Cassandra keyspace
description: Script do PowerShell do Azure – Azure Cosmos DB criar tabela e a API do Cassandra keyspace
author: markjbrown
...
ms.locfileid: "66247013"
---
# <a name="create-a-keyspace-and-table-for-azure-cosmos-db---cassandra-api"></a>Criar um keyspace e uma tabela para o Azure Cosmos DB – API do Cassandra
