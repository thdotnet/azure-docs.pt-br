...
> [!NOTE]
> Este exemplo demonstra como usar uma conta de API do SQL (Core). Para usar esse exemplo para outras APIs, aplique o parâmetro `ip-range-filter` no script abaixo ao comando `az cosmosdb account create` para seu script específico da API.
