...
### <a name="batch-reads-from-cosmos-db"></a>Leituras de lote do Cosmos DB
...
### <a name="batch-writes-to-cosmos-db"></a>Gravações em lotes para o Cosmos DB
...
### <a name="streaming-reads-from-cosmos-db"></a>Streaming de leituras do Cosmos DB

O trecho a seguir mostra como conectar e ler do Feed de alterações do Azure Cosmos DB.
...
### <a name="streaming-writes-to-cosmos-db"></a>Streaming de gravações no Cosmos DB
