...
+ <a href="#datasets-and-datastores">Armazenamentos de dados e o conjunto de dados</a>
+ <a href="#compute-targets">Destinos de computação</a>
+ <a href="#training-scripts">Script de treinamento</a>
+ <a href="#runs">Run</a>
+ <a href="#github-tracking-and-integration">Acompanhamento de Git</a>
...
+ <a href="#ml-pipelines">Pipelines do ML</a>
...
O **registro de modelo** mantém o controle de todos os modelos no seu espaço de trabalho do serviço de Azure Machine Learning.
...
Para obter mais informações, consulte [criar e registrar conjuntos de dados do Azure Machine Learning](how-to-create-register-datasets.md).  Para obter mais exemplos usando conjuntos de dados, consulte o [notebooks de exemplo](https://aka.ms/dataset-tutorial).

Um **datastore** é uma abstração de armazenamento de uma conta de armazenamento do Azure. O repositório de dados pode usar um contêiner de blob do Azure ou um compartilhamento de arquivos do Azure como o armazenamento de back-end. Cada workspace tem um repositório de dados padrão e você poderá registrar repositórios de dados adicionais. Use a API do SDK do Python ou a CLI do Azure Machine Learning para armazenar e recuperar arquivos do repositório de dados.
...
Saiba mais sobre o [destinos de computação disponíveis para treinamento e implantação](concept-compute-target.md). 
...
Imagens são catalogadas na **registro de imagem** no espaço de trabalho. Você pode fornecer as marcas de metadados adicionais quando você cria a imagem, para que você possa consultá-los para localizar a imagem mais tarde.
...
Para obter um exemplo de implantação de um modelo usando uma imagem personalizada, consulte [como implantar um modelo usando uma imagem personalizada do Docker](how-to-deploy-custom-docker-image.md).
...
#### <a name="iot-module-deployments"></a>Implantações de módulo do IoT
