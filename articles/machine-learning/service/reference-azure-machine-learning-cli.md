...
Para atualizar a extensão de CLI de Machine Learning, use o seguinte comando:
...
+ Implantar o modelo para o AKS
    ...
    ```
    Este é um exemplo de documento 'deploymentconfig.json':
    ```json
    {
    "computeType": "aks",
...
* [Treinar e implantar modelos de aprendizado de máquina usando Pipelines do Azure](/azure/devops/pipelines/targets/azure-machine-learning)
