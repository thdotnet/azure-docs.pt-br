...
| Menu | DESCRIÇÃO |
| ---- | ----------- |
| ![Menu de navegação à esquerda](media/overview-iot-central-tour-pnp/navigationbar.png) | <ul><li>A página **Painel** exibe o painel do aplicativo. Como um construtor, você pode personalizar o painel para seus operadores. Os usuários também podem criar seus próprios painéis.</li><li>A página **Dispositivos** lista os dispositivos simulados e reais associados a cada modelo de dispositivo no aplicativo. Como operador, use **Dispositivos** para gerenciar os dispositivos conectados.</li><li>A página **Grupos de dispositivos** permite exibir e criar grupos de dispositivos. Como operador, você pode criar grupos de dispositivos como uma coleção lógica de dispositivos especificados por uma consulta.</li><li>A página **Regras** permite que você edite regras que são acionadas com base na telemetria do dispositivo e disparam ações personalizáveis.</li><li>A página **Análise** mostra a análise derivada da telemetria do dispositivo para dispositivos e grupos de dispositivos. Como um operador, você pode criar exibições personalizadas sobre dados do dispositivo para derivar insights de seu aplicativo.</li><li>A página **Trabalhos** habilita o gerenciamento de dispositivo em massa fazendo você criar e executar trabalhos para atualizar os dispositivos em escala.</li><li>A página **Modelos de dispositivo** mostra as ferramentas usadas por um construtor para criar e gerenciar modelos de dispositivo.</li><li>A página **Exportação de Dados** permite que um administrador configure uma exportação contínua para outros serviços do Azure, como armazenamento e filas.</li><li>A página **Administração** mostra as páginas de administração do aplicativo em que um administrador pode gerenciar as configurações de aplicativo, usuários e funções.</li></ul> |
