...
* Como desenvolvedor de dispositivos, para usar Visual Studio Code para criar um dispositivo de [plug and Play IOT](https://aka.ms/iot-pnp-docs) que se conecta ao seu aplicativo IOT central.
