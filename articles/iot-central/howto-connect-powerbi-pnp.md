...
![Pipeline de solução do Power BI](media/howto-connect-powerbi-pnp/iot-continuous-data-export.png)
...
- Dados exportados usando a [Exportação de dados contínua](howto-export-data-blob-storage-pnp.md?toc=/azure/iot-central-pnp/toc.json&bc=/azure/iot-central-pnp/breadcrumb/toc.json) do seu aplicativo IoT Central. Recomendamos que você ative medições, dispositivos e fluxos de modelos de dispositivos para aproveitar ao máximo o painel do Power BI.
...
![Página de relatório do Power BI 1](media/howto-connect-powerbi-pnp/template-page1-hasdata.PNG)
...
![Exibição de grupo de recursos do portal do Azure](media/howto-connect-powerbi-pnp/azure-deployment.PNG)
