...
Para confirmar que um grupo de gerenciamento do Operations Manager está se comunicando com os logs do Azure Monitor, consulte [integração de validar o Operations Manager com os logs do Azure Monitor](../azure-monitor/platform/om-agents.md#validate-operations-manager-integration-with-azure-monitor).
...
## <a name="remove-a-vm-from-update-management"></a>Remover uma VM de gerenciamento de atualizações
