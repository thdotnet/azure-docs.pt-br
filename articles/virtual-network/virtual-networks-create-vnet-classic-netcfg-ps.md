...
Este documento aborda a criação de uma Rede Virtual usando o modelo de implantação clássica. Também é possível [criar uma rede virtual no modelo de implantação do Gerenciador de Recursos](quick-create-powershell.md).
