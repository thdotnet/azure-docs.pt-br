...
5. Insira os valores dos seguintes parâmetros:
   ...
   - **Delegação de sub-rede:** Uma sub-rede pode ter zero ou várias delegações habilitadas para ela. A delegação de sub-rede dá permissões explícitas ao serviço para criar recursos específicos do serviço na sub-rede, usando um identificador exclusivo ao implantar o serviço. Para delegar para um serviço, selecione o serviço que você deseja delegar na lista **Serviços**.
