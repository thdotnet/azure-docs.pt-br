...
### <a name="create-an-application-security-group"></a>Criar um grupo de segurança do aplicativo
...
3. Insira ou selecione as seguintes informações e selecione **Criar**:
    ...
    | Local padrão       | Selecione uma localização                                       |
