...
Se seus aplicativos, ferramentas ou produtos estão usando o [API de tradução de fala](https://docs.microsoft.com/azure/cognitive-services/translator-speech/overview), nós criamos guias para ajudá-lo a migrar para os serviços de fala.
