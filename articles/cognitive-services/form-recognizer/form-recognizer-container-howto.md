...
O contêiner fornece APIs de ponto de extremidade REST, que podem ser encontradas [aqui](https://westus2.dev.cognitive.microsoft.com/docs/services/form-recognizer-api/operations/AnalyzeWithCustomModel).
