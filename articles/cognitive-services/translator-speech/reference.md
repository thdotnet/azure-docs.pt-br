...
|from|(vazio)   |Especifica o idioma da fala recebida. O valor é um dos identificadores de idioma do escopo de `speech` na resposta da API de idiomas.|query|cadeia de caracteres|
