...
ms.locfileid: "68881250"
---
# <a name="use-computer-vision-features-with-the-rest-api-and-java"></a>Usar recursos de Pesquisa Visual Computacional com API REST e Java
...
Neste guia, você usou a API REST do Pesquisa Visual Computacional com Java para testar muitos dos recursos de análise de imagem disponíveis. Em seguida, veja a documentação de referência para saber mais sobre as APIs envolvidas.
