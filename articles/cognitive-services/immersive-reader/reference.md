...
| Nome | Tipo | Descrição |
| ---- | ---- |------------ |
| `token` | cadeia de caracteres | O token de autenticação do Azure AD. Consulte o [tutorial de autenticação do Azure ad](./azure-active-directory-authentication.md). |
