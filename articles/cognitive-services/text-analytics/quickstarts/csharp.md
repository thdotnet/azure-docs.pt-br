...
2. Gere uma lista de objetos `MultiLanguageInput` contendo os documentos que você deseja analisar.
...
2. Gere uma lista de objetos `LanguageInput` contendo os documentos.
