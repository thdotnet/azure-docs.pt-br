...
| 400050| O texto de entrada é muito longo. Modo de exibição [limites de solicitação](../request-limits.md).|
...
| 400077| O tamanho máximo da solicitação foi excedido. Modo de exibição [limites de solicitação](../request-limits.md).|
| 400079| O sistema personalizado solicitado para tradução entre e para o idioma não existe.|
| 400080| Não há suporte para a transliteração para o idioma ou script.|
...
| 408002| Solicitação atingiu o tempo limite aguardando o fluxo de entrada. O cliente não produziu uma solicitação dentro do tempo que o servidor foi preparado para aguardar. O cliente pode repetir a solicitação sem modificações em qualquer momento posterior.|
