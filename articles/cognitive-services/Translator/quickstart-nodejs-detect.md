...
Se estiver usando uma assinatura de vários Serviços Cognitivos, você também deve incluir o `Ocp-Apim-Subscription-Region` em seus cabeçalhos de solicitação. 
