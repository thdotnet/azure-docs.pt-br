...
|[Tradução de Fala](https://docs.microsoft.com/azure/cognitive-services/translator-speech/ "Tradução de Fala") (desativação)|A Tradução de Fala é um serviço de tradução automática.|
...
|[Personalizador](https://docs.microsoft.com/azure/cognitive-services/personalizer/ "Personalizador") (versão prévia)|O Personalizador permite escolher a melhor experiência a ser mostrada aos usuários, aprendendo com o comportamento deles em tempo real.|
