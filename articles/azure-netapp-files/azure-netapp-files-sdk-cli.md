---
title: SDKs de arquivos NetApp do Azure | Microsoft Docs
description: Lista os SDKs com suporte pelos arquivos do Azure NetApp.
...
ms.locfileid: "65957874"
---
# <a name="azure-netapp-files-sdks"></a>SDKs do Azure NetApp Files

Este artigo lista os SDKs com suporte pelos arquivos do Azure NetApp.
...
|    Linguagem    |    Local do SDK publicado    |
|------------------|--------------------------------------------------------------------------------------------|
...
## <a name="next-steps"></a>Próximas etapas   
 [Baixe os SDKs do Azure](https://azure.microsoft.com/downloads/)
