...
|----------------------------|----------|----------|---------|---------|--------------|------------|--------|----------|----------|-------------|
|          |EUA Central|East US|Leste dos EUA 2|Oeste dos EUA 2|Centro da França|Europa Setentrional|Sul do Reino Unido|Europa Ocidental|Leste do Japão|Sudeste da Ásia|
| **Computação**                         |            |              |           |           |                |              |          |             |            |                |
