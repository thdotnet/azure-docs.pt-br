...
> | Tipo de Ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.AzureActiveDirectory/b2cDirectories/delete | Excluir recursos do Diretório B2C |
> | Ação | Microsoft.AzureActiveDirectory/b2cDirectories/read | Exibir recursos do Diretório B2C |
...
> | Ação | Microsoft. billing/validateAddress/Write |  |
...
> | Ação | Microsoft.BingMaps/mapApis/listSecrets/action | Lista os Segredos |
...
> | Tipo de Ação | Operação | Descrição |
> | --- | --- | --- |
> | Ação | Microsoft.Blueprint/blueprintAssignments/assignmentOperations/read | Ler qualquer artefato de blueprint |
> | Ação | Microsoft.Blueprint/blueprintAssignments/delete | Excluir qualquer artefato de blueprint |
> | Ação | Microsoft.Blueprint/blueprintAssignments/read | Ler qualquer artefato de blueprint |
...
> | Ação | Microsoft.Blueprint/blueprints/artifacts/delete | Excluir qualquer artefato de blueprint |
> | Ação | Microsoft.Blueprint/blueprints/artifacts/read | Ler qualquer artefato de blueprint |
...
> | Ação | Microsoft.Blueprint/blueprints/read | Ler qualquer blueprint |
> | Ação | Microsoft.Blueprint/blueprints/versions/artifacts/read | Ler qualquer artefato de blueprint |
> | Ação | Microsoft.Blueprint/blueprints/versions/delete | Excluir qualquer blueprint |
> | Ação | Microsoft.Blueprint/blueprints/versions/read | Ler qualquer blueprint |
> | Ação | Microsoft.Blueprint/blueprints/versions/write | Criar ou atualizar qualquer blueprint |
> | Ação | Microsoft.Blueprint/blueprints/write | Criar ou atualizar qualquer blueprint |
...
> | Ação | Microsoft.ClassicCompute/domainNames/capabilities/read | Mostra os recursos do nome de domínio |
...
> | Ação | Microsoft.ClassicCompute/register/action | Registrar na Computação Clássica |
...
> | Ação | Microsoft. Data Box/subscriptions/resourceGroups/moveResources/Action |  |
> | Ação | Microsoft. Data Box/subscriptions/resourceGroups/validateMoveResources/Action |  |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/getExtendedInformation/action | Recupera as informações estendidas do recurso |
...
> | Ação | Microsoft.DataBoxEdge/dataBoxEdgeDevices/uploadCertificate/action | Carregar certificado para o registro do dispositivo |
...
> | Ação | Microsoft.Insights/Components/Annotations/Write | Gravando uma anotação do Application Insights |
...
> | Ação | Microsoft.Insights/Components/Favorites/Delete | Excluindo um favorito do Application Insights |
...
> | Ação | Microsoft.Insights/Components/Webtests/Read | Lendo uma configuração de teste da web |
...
> | Ação | Microsoft.Insights/Metrics/Microsoft.Insights/Read | Ler as métricas |
> | Ação | Microsoft.Insights/Metrics/providers/Metrics/Read | Ler as métricas |
> | Ação | Microsoft.Insights/Metrics/Read | Ler as métricas |
...
> | Ação | Microsoft.Insights/Register/Action | Registre o provedor do Microsoft Insights |
...
> | Ação | Microsoft.Insights/Unregister/Action | Registre o provedor do Microsoft Insights |
...
> | Ação | Microsoft.Insights/Webtests/Read | Lendo uma configuração de teste da web |
...
> | Ação | Microsoft. OperationalInsights/Workspaces/Query/Microservices4SpringApplicationLogs/Read | Ler dados da tabela Microservices4SpringApplicationLogs |
...
> | Ação | Microsoft.RecoveryServices/Locations/backupProtectedItem/write | Criar um Item Protegido em backup |
...
> | Ação | Microsoft.RecoveryServices/Vaults/backupFabrics/protectableContainers/read | Obtenha todos os contêineres que podem ser protegidos |
...
> | Ação | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContainers/operationResults/read | Obtém o resultado da Operação realizada no Contêiner de Proteção. |
...
> | Ação | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContainers/protectedItems/backup/action | Faz Backup de Item Protegido. |
> | Ação | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContainers/protectedItems/delete | Exclui o Item Protegido |
> | Ação | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContainers/protectedItems/operationResults/read | Obtém o Resultado da Operação Realizada em Itens Protegidos. |
> | Ação | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContainers/protectedItems/operationsStatus/read | Retorna o status da Operação realizada em Itens Protegidos. |
...
> | Ação | Microsoft.RecoveryServices/Vaults/backupFabrics/protectionContainers/protectedItems/write | Criar um Item Protegido em backup |
...
> | Ação | Microsoft.RecoveryServices/Vaults/backupOperationResults/read | Retorna o Resultado da Operação de Backup do Cofre de Serviços de Recuperação. |
...
> | Ação | Microsoft.RecoveryServices/Vaults/backupPolicies/write | Cria uma Política de Proteção |
> | Ação | Microsoft.RecoveryServices/Vaults/backupProtectableItems/read | Retorna a lista de todos os Itens a Proteger. |
> | Ação | Microsoft.RecoveryServices/Vaults/backupProtectedItems/read | Retorna a lista de todos os Itens Protegidos. |
> | Ação | Microsoft.RecoveryServices/Vaults/backupProtectionContainers/read | Retorna todos os contêineres pertencentes à assinatura |
...
> | Ação | Microsoft.RecoveryServices/Vaults/certificates/write | A operação Atualizar Certificado de Recurso atualiza o certificado de credencial de cofre/recurso. |
...
> | Ação | Microsoft.RecoveryServices/Vaults/extendedInformation/delete | A operação Obter Informações Estendidas obtém as Informações Estendidas de um objeto que representa o recurso do Azure do tipo ?vault? |
> | Ação | Microsoft.RecoveryServices/Vaults/extendedInformation/read | A operação Obter Informações Estendidas obtém as Informações Estendidas de um objeto que representa o recurso do Azure do tipo ?vault? |
> | Ação | Microsoft.RecoveryServices/Vaults/extendedInformation/write | A operação Obter Informações Estendidas obtém as Informações Estendidas de um objeto que representa o recurso do Azure do tipo ?vault? |
...
> | Ação | Microsoft.RecoveryServices/Vaults/read | A operação Obter Cofre obtém um objeto representando o recurso do Azure de tipo 'cofre' |
...
> | Ação | Microsoft.RecoveryServices/Vaults/registeredIdentities/operationResults/read | A operação Obter Resultados da Operação pode ser usada para obter o status e o resultado da operação para a operação enviada de forma assíncrona |
...
> | Ação | Microsoft.RecoveryServices/vaults/replicationFabrics/migratetoaad/action | Migrar o Fabric para o AAD |
...
> | Ação | Microsoft.RecoveryServices/vaults/replicationFabrics/renewcertificate/action | Renovar o Certificado Para a Malha |
...
> | Ação | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/discoverProtectableItem/action | Descobrir Item a Proteger |
...
> | Ação | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectedItems/reProtect/action | Proteger Novamente Item Protegido |
...
> | Ação | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/replicationProtectionContainerMappings/remove/action | Remover Mapeamento de Contêineres de Proteção |
...
> | Ação | Microsoft.RecoveryServices/vaults/replicationFabrics/replicationProtectionContainers/switchprotection/action | Trocar Contêiner de Proteção |
...
> | Ação | Microsoft.RecoveryServices/vaults/replicationRecoveryPlans/reProtect/action | Plano de Recuperação de Nova Proteção |
...
> | Ação | Microsoft.RecoveryServices/Vaults/usages/read | Retorna detalhes de uso do Cofre de Serviços de Recuperação. |
> | Ação | Microsoft.RecoveryServices/Vaults/vaultTokens/read | A operação do Token do Cofre pode ser usada para obter o Token do Cofre para operações de back-end do nível do cofre. |
...
> | Ação | Microsoft. Resources/Implantations/exportatemplate/ação | Exportar o modelo para uma implantação |
...
> | Ação | Microsoft. Storage/storageAccounts/privateEndpointConnectionProxies/Read | Obter o Proxy de Conexão do Ponto de Extremidade Privado |
...
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/delete | Excluir Conexão de Ponto de Extremidade Privado |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/read | Obter Conexão de Ponto de Extremidade Privado |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/write | Colocar Conexão de Ponto de Extremidade Privado |
...
> | Ação | Microsoft.StorSimple/Managers/certificates/write | A operação Atualizar Certificado de Recurso atualiza o certificado de credencial de cofre/recurso. |
...
> | Ação | Microsoft.StorSimple/Managers/extendedInformation/delete | A operação Obter Informações Estendidas obtém as Informações Estendidas de um objeto que representa o recurso do Azure do tipo ?vault? |
> | Ação | Microsoft.StorSimple/managers/extendedInformation/read | Lista ou obtém as informações estendidas do cofre |
> | Ação | Microsoft.StorSimple/Managers/extendedInformation/read | A operação Obter Informações Estendidas obtém as Informações Estendidas de um objeto que representa o recurso do Azure do tipo ?vault? |
> | Ação | Microsoft.StorSimple/managers/extendedInformation/write | Criar ou atualizar as informações estendidas do cofre |
> | Ação | Microsoft.StorSimple/Managers/extendedInformation/write | A operação Obter Informações Estendidas obtém as Informações Estendidas de um objeto que representa o recurso do Azure do tipo ?vault? |
...
> | Ação | Microsoft.StorSimple/Managers/read | A operação Obter Cofre obtém um objeto representando o recurso do Azure de tipo 'cofre' |
...
> | Ação | Microsoft.Subscription/CreateSubscription/action | Criar uma assinatura do Azure |
