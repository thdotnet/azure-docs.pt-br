...
> | Ação | Microsoft.AAD/domainServices/replicaSets/delete | Excluir o Site de Cluster |
> | Ação | Microsoft.AAD/domainServices/replicaSets/read | Site de Cluster de leitura |
> | Ação | Microsoft.AAD/domainServices/replicaSets/write | Gravar o Site de Cluster |
...
> | Ação | Microsoft.ADHybridHealthService/services/reports/blobUris/read | Obtém todos os URIs de relatório de IP arriscado para nos últimos 7 dias. |
...
> | Ação | Microsoft.ADHybridHealthService/services/reports/generateBlobUri/action | Gera o relatório IP arriscado e retorna um URI apontando para ele. |
...
> | Ação | Microsoft.ADHybridHealthService/services/servicemembers/metrics/read | Obtém a lista de conectores e nomes de perfil de execução para o serviço em questão e o membro de serviço. |
...
> | Ação | Microsoft.AlertsManagement/smartDetectorAlertRules/delete | Excluir regra de alerta de Detector inteligentes em uma determinada assinatura |
> | Ação | Microsoft.AlertsManagement/smartDetectorAlertRules/read | Obter todas as regras de alerta de Detector inteligentes para os filtros de entrada |
> | Ação | Microsoft.AlertsManagement/smartDetectorAlertRules/write | Criar ou atualizar regra de alerta de Detector inteligentes em uma determinada assinatura |
...
> | Ação | Microsoft.ApiManagement/service/apis/diagnostics/read | Lista todos os diagnósticos de uma API. ou obtém os detalhes do diagnóstico para uma API especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/diagnostics/write | Cria um novo diagnóstico para uma API ou atualizar uma existente. ou atualizações, os detalhes do diagnóstico para uma API especificados por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/attachments/delete | Exclui o comentário especificado de um problema. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/attachments/read | Lista todos os anexos para o problema associado com a API especificada. ou obtém os detalhes do problema anexo para uma API especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/attachments/write | Cria um novo anexo para o problema em uma API ou atualizar uma existente. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/comments/delete | Exclui o comentário especificado de um problema. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/comments/read | Lista todos os comentários para o problema associado com a API especificada. ou obtém os detalhes do problema de comentário para uma API especificada por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/comments/write | Cria um novo comentário para o problema em uma API ou atualizar uma existente. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/delete | Exclui o problema especificado de uma API. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/read | Lista todos os problemas associados com a API especificada. ou obtém os detalhes do problema para uma API especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/issues/write | Cria um novo problema para uma API ou atualizar uma existente. ou um existente emitir para uma API de atualizações. |
...
> | Ação | Microsoft.ApiManagement/service/apis/operations/policies/read | Obter a lista de configuração de política no nível da operação de API. ou obtenha a configuração de política no nível da operação de API. |
...
> | Ação | Microsoft.ApiManagement/service/apis/operations/read | Lista uma coleção de operações para a API especificada. ou obtém os detalhes da operação de API especificada por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/tags/delete | Desanexe a marca da operação. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/tags/read | Lista todas as marcas associadas à operação. ou obter marcas associadas à operação. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/tags/write | Atribua a marca para a operação. |
> | Ação | Microsoft.ApiManagement/service/apis/operations/write | Cria uma nova operação na API ou atualizar uma existente. ou atualizações, os detalhes da operação na API especificados por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/apis/operationsByTags/read | Lista uma coleção de operações associadas com marcas. |
> | Ação | Microsoft.ApiManagement/service/apis/policies/delete | Exclui a configuração de política de API. |
> | Ação | Microsoft.ApiManagement/service/apis/policies/read | Obter a configuração de política no nível da API. ou obtenha a configuração de política no nível da API. |
> | Ação | Microsoft.ApiManagement/service/apis/policies/write | Cria ou atualiza a configuração de política para a API. |
> | Ação | Microsoft.ApiManagement/service/apis/policy/delete | Excluir a configuração de política no nível de API |
> | Ação | Microsoft.ApiManagement/service/apis/policy/read | Obter a configuração de política no nível de API |
> | Ação | Microsoft.ApiManagement/service/apis/policy/write | Criar configuração de política no API nível |
> | Ação | Microsoft.ApiManagement/service/apis/products/read | Lista todos os produtos, o que a API faz parte do. |
...
> | Ação | Microsoft.ApiManagement/service/apis/releases/read | Lista todas as versões de uma API.<br>Uma versão de API é criada ao fazer uma revisão de API atual.<br>Versões também são usados para reverter para as revisões anteriores.<br>Os resultados serão paginados e podem ser restrito pelos parâmetros $top e $skip.<br>ou retorna os detalhes de uma API de versão. |
> | Ação | Microsoft.ApiManagement/service/apis/releases/write | Cria uma nova versão da API. ou atualizações, os detalhes da versão da API especificados por seu identificador. |
...
> | Ação | Microsoft.ApiManagement/service/apis/schemas/delete | Exclui a configuração de esquema de API. |
...
> | Ação | Microsoft.ApiManagement/service/apis/tagDescriptions/read | Lista todas as descrições de marcas no escopo da API. Semelhante do swagger de modelo – tagDescription é definido no nível da API, mas marca pode ser atribuída às operações ou obter a descrição da marca no escopo da API |
> | Ação | Microsoft.ApiManagement/service/apis/tagDescriptions/write | Criar/Atualizar descrição da marca no escopo da Api. |
> | Ação | Microsoft.ApiManagement/service/apis/tags/delete | Desanexe a marca da Api. |
> | Ação | Microsoft.ApiManagement/service/apis/tags/read | Lista todas as marcas associadas com a API. ou obtenha associada com a API de marcação. |
> | Ação | Microsoft.ApiManagement/service/apis/tags/write | Atribua a marca para a Api. |
> | Ação | Microsoft.ApiManagement/service/apis/write | Cria novos ou atualizar a API especificada existente da instância do serviço de gerenciamento de API. ou atualizações de API especificada da instância do serviço de gerenciamento de API. |
> | Ação | Microsoft.ApiManagement/service/apisByTags/read | Lista uma coleção de apis associadas com marcas. |
> | Ação | Microsoft.ApiManagement/service/apiVersionSets/delete | Exclui a versão da Api específica definida. |
> | Ação | Microsoft.ApiManagement/service/apiVersionSets/read | Lista uma coleção de conjuntos de versão de API na instância do serviço especificado. ou obtém os detalhes do conjunto de versão de Api especificada por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/apiVersionSets/versions/read | Obter lista de entidades de versão |
> | Ação | Microsoft.ApiManagement/service/apiVersionSets/write | Cria ou atualiza um conjunto de versão da Api. ou atualizações os detalhes do VersionSet a Api que especificado por seu identificador. |
...
> | Ação | Microsoft.ApiManagement/service/authorizationServers/delete | Exclui a instância do servidor de autorização específica. |
> | Ação | Microsoft.ApiManagement/service/authorizationServers/read | Lista uma coleção de servidores de autorização definida em uma instância de serviço. ou obtém os detalhes do servidor de autorização especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/authorizationServers/write | Criar novo servidor de autorização ou atualizar um servidor de autorização existente. ou atualizações os detalhes do servidor de autorização especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/backends/delete | Exclui o back-end especificado. |
> | Ação | Microsoft.ApiManagement/service/backends/read | Lista uma coleção de back-ends na instância do serviço especificado. ou obtém os detalhes do back-end especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/backends/reconnect/action | Notifica o proxy APIM para criar uma nova conexão para o back-end após o tempo limite especificado. Se nenhum tempo limite foi especificado, o tempo limite de 2 minutos é usado. |
...
> | Ação | Microsoft.ApiManagement/service/caches/delete | Exclui um Cache específico. |
> | Ação | Microsoft.ApiManagement/service/caches/read | Lista uma coleção de todos os Caches externos na instância do serviço especificado. ou obtém os detalhes do Cache especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/caches/write | Cria ou atualiza um Cache externo a ser usado na instância de gerenciamento de Api. ou atualizações os detalhes do cache especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/certificates/delete | Exclui um certificado específico. |
> | Ação | Microsoft.ApiManagement/service/certificates/read | Lista uma coleção de todos os certificados na instância do serviço especificado. ou obtém os detalhes do certificado especificado por seu identificador. |
...
> | Ação | Microsoft.ApiManagement/service/diagnostics/write | Cria um novo diagnóstico ou atualiza uma existente. ou atualizações os detalhes do diagnóstico especificado por seu identificador. |
...
> | Ação | Microsoft.ApiManagement/service/groups/delete | Exclui um grupo específico da instância do serviço de gerenciamento de API. |
> | Ação | Microsoft.ApiManagement/service/groups/read | Lista uma coleção de grupos definida em uma instância de serviço. ou obtém os detalhes do grupo especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/groups/users/delete | Remova usuário existente do grupo existente. |
> | Ação | Microsoft.ApiManagement/service/groups/users/read | Lista uma coleção de entidades de usuário associada ao grupo. |
> | Ação | Microsoft.ApiManagement/service/groups/users/write | Adicionar usuário existente a grupo existente |
> | Ação | Microsoft.ApiManagement/service/groups/write | Cria ou atualiza um grupo. ou atualizações os detalhes do grupo especificado por seu identificador. |
...
> | Ação | Microsoft.ApiManagement/service/identityProviders/read | Lista uma coleção de provedor de identidade configurado na instância do serviço especificado. ou obtém os detalhes de configuração de provedor de identidade configurado na instância do serviço especificado. |
...
> | Ação | Microsoft.ApiManagement/service/issues/read | Lista uma coleção dos problemas na instância do serviço especificado. ou gerenciamento de API obtém detalhes do problema |
...
> | Ação | Microsoft.ApiManagement/service/loggers/read | Lista uma coleção de agentes na instância do serviço especificado. ou obtém os detalhes do agente de log especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/loggers/write | Cria ou atualiza um agente de log. ou atualizar um agente existente. |
...
> | Ação | Microsoft.ApiManagement/service/notifications/read | Lista uma coleção de propriedades definidas dentro de uma instância de serviço. ou obtém os detalhes da notificação especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientEmails/delete | Remove o email da lista de notificação. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientEmails/read | Obtém a lista dos Emails do destinatário de notificação assinar uma notificação. |
...
> | Ação | Microsoft.ApiManagement/service/notifications/recipientUsers/delete | Remove o usuário de gerenciamento de API da lista de notificação. |
> | Ação | Microsoft.ApiManagement/service/notifications/recipientUsers/read | Obtém a lista do usuário do destinatário de notificação assinou a notificação. |
...
> | Ação | Microsoft.ApiManagement/service/notifications/write | Criar ou notificação do publicador de gerenciamento de API de atualização. |
> | Ação | Microsoft.ApiManagement/service/openidConnectProviders/delete | Exclui o OpenID Connect provedor específico da instância do serviço de gerenciamento de API. |
> | Ação | Microsoft.ApiManagement/service/openidConnectProviders/read | Lista todos os provedores do OpenId Connect. ou obtém específico provedor OpenID Connect. |
> | Ação | Microsoft.ApiManagement/service/openidConnectProviders/write | Cria ou atualiza o provedor do OpenID Connect. ou o OpenID Connect provedor específico de atualizações. |
...
> | Ação | Microsoft.ApiManagement/service/policy/write | Criar configuração de política no locatário nível |
> | Ação | Microsoft.ApiManagement/service/policySnippets/read | Lista todos os trechos de política. |
> | Ação | Microsoft.ApiManagement/service/portalsettings/read | Obter logon nas configurações para o Portal ou o sinal de Get até as configurações para o Portal ou obter as configurações de delegação para o Portal. |
> | Ação | Microsoft.ApiManagement/service/portalsettings/write | Atualize configurações de entrada. ou as configurações de criação ou atualização de entrada. ou atualizar configurações ou atualizar configurações ou atualizar configurações de delegação. ou as configurações de criação ou atualização de delegação. |
> | Ação | Microsoft.ApiManagement/service/products/apis/delete | Exclui a API especificada do produto especificado. |
> | Ação | Microsoft.ApiManagement/service/products/apis/read | Listas de uma coleção de APIs do associado a um produto. |
> | Ação | Microsoft.ApiManagement/service/products/apis/write | Adiciona uma API ao produto especificado. |
> | Ação | Microsoft.ApiManagement/service/products/delete | Exclua o produto. |
> | Ação | Microsoft.ApiManagement/service/products/groups/delete | Exclui a associação entre o grupo especificado e o produto. |
...
> | Ação | Microsoft.ApiManagement/service/products/policies/delete | Exclui a configuração de política de produto. |
> | Ação | Microsoft.ApiManagement/service/products/policies/read | Obter a configuração de política no nível do produto. ou obtenha a configuração de política no nível do produto. |
...
> | Ação | Microsoft.ApiManagement/service/products/read | Lista uma coleção de produtos na instância do serviço especificado. ou obtém os detalhes do produto especificado por seu identificador. |
...
> | Ação | Microsoft.ApiManagement/service/products/tags/read | Lista todas as marcas associadas com o produto. ou obtenha marca associada ao produto. |
> | Ação | Microsoft.ApiManagement/service/products/tags/write | Atribua a marca para o produto. |
...
> | Ação | Microsoft.ApiManagement/service/productsByTags/read | Lista uma coleção de produtos associados com marcas. |
...
> | Ação | Microsoft.ApiManagement/service/properties/read | Lista uma coleção de propriedades definidas dentro de uma instância de serviço. ou obtém os detalhes da propriedade especificada por seu identificador. |
...
> | Ação | Microsoft.ApiManagement/service/regions/read | Lista todas as regiões do azure no qual o serviço existe. |
...
> | Ação | Microsoft.ApiManagement/service/subscriptions/regeneratePrimaryKey/action | Regenera a chave primária de uma assinatura existente da instância do serviço de gerenciamento de API. |
...
> | Ação | Microsoft.ApiManagement/service/subscriptions/write | Cria ou atualiza a assinatura de usuário especificado para o produto especificado. ou os detalhes de uma assinatura especificada por seu identificador de atualizações. |
> | Ação | Microsoft.ApiManagement/service/tagResources/read | Lista uma coleção de recursos associados com marcas. |
> | Ação | Microsoft.ApiManagement/service/tags/delete | Exclui uma marca específica da instância do serviço de gerenciamento de API. |
> | Ação | Microsoft.ApiManagement/service/tags/read | Lista uma coleção de marcas definidas dentro de uma instância de serviço. ou obtém os detalhes da marca especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/tags/write | Cria uma marca. ou atualizações os detalhes da marca especificado por seu identificador. |
...
> | Ação | Microsoft.ApiManagement/service/tenant/read | Obtenha a definição de política Global do serviço de gerenciamento de Api. ou obter detalhes de informações de acesso de locatário |
...
> | Ação | Microsoft.ApiManagement/service/users/generateSsoUrl/action | Recupera uma URL de redirecionamento que contém um token de autenticação para um determinado usuário de assinatura no portal do desenvolvedor. |
...
> | Ação | Microsoft.ApiManagement/service/users/read | Lista uma coleção de usuários registrados na instância do serviço especificado. ou obtém os detalhes do usuário especificado por seu identificador. |
> | Ação | Microsoft.ApiManagement/service/users/subscriptions/read | Lista a coleção de assinaturas do usuário especificado. |
> | Ação | Microsoft.ApiManagement/service/users/token/action | Obtém a autorização de acesso compartilhado Token para o usuário. |
> | Ação | Microsoft.ApiManagement/service/users/write | Cria ou atualiza um usuário. ou atualizações os detalhes do usuário especificado por seu identificador. |
...
> | Ação | Microsoft.AzureActiveDirectory/b2ctenants/read | Lista todos os locatários B2C dos quais o usuário é membro |
...
> | Tipo de ação | Operação | DESCRIÇÃO |
> | --- | --- | --- |
> | Ação | Microsoft.Billing/billingAccounts/departments/read | Lista todos os departamentos no escopo de uma conta de cobrança |
> | Ação | Microsoft.Billing/billingAccounts/enrollmentAccounts/read | Lista todas as contas de registro no escopo de uma conta de cobrança |
> | Ação | Microsoft.Billing/billingAccounts/read | Lista todas as contas de cobrança às quais o usuário tem acesso |
> | Ação | Microsoft.Billing/billingPeriods/read | Listar os períodos de cobrança disponíveis |
> | Ação | Microsoft.Billing/departments/read | Lista todos os departamentos aos quais o usuário tem acesso |
> | Ação | Microsoft.Billing/invoices/read | Listar faturas disponíveis |
> | Ação | Microsoft.Billing/register/action | Registra a Assinatura no provedor de recursos Microsoft.Billing |
...
> | Tipo de ação | Operação | DESCRIÇÃO |
> | --- | --- | --- |
> | Ação | Microsoft.Blockchain/blockchainMembers/delete | Exclui um membro existente de Blockchain. |
> | Ação | Microsoft.Blockchain/blockchainMembers/listApiKeys/action | Obtém ou lista de chaves de Api do membro de Blockchain existentes. |
> | Ação | Microsoft.Blockchain/blockchainMembers/read | Obtém ou lista os membros existentes do Blockchain. |
> | DataAction | Microsoft.Blockchain/blockchainMembers/transactionNodes/connect/action | Se conecta a um nó de transação do membro de Blockchain. |
> | Ação | Microsoft.Blockchain/blockchainMembers/transactionNodes/delete | Exclui um nó de transação de membro existente do Blockchain. |
> | Ação | Microsoft.Blockchain/blockchainMembers/transactionNodes/listApiKeys/action | Obtém ou lista de chaves de Api de nó de transação do Blockchain membro existente. |
> | Ação | Microsoft.Blockchain/blockchainMembers/transactionNodes/read | Obtém ou lista existente Blockchain membro transação nó (s). |
> | Ação | Microsoft.Blockchain/blockchainMembers/transactionNodes/write | Cria ou atualiza um nó de transação do membro de Blockchain. |
...
> | Ação | Microsoft.Blockchain/locations/checkNameAvailability/action | Verificar esse nome de recurso é válido e não está em uso. |
> | Ação | Microsoft.Blockchain/operations/read | Liste todas as operações no provedor de recursos de Blockchain do Microsoft. |
> | Ação | Microsoft.Blockchain/register/action | Registra a assinatura para o provedor de recursos do Blockchain. |
...
> | Ação | Microsoft.Blueprint/blueprintAssignments/whoisblueprint/action | Obter a ID do objeto da entidade de serviço do Azure Blueprints. |
...
> | Ação | Microsoft.Capacity/calculateexchange/action | Calcula a quantidade de exchange e o preço de compra de novos e retorna erros de política. |
...
> | Ação | Microsoft.Capacity/reservationorders/calculaterefund/action | Calcula o valor de reembolso e o preço de compra de novos e retorna erros de política. |
...
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/areaofinterest/action | Essa operação retorna uma caixa delimitadora em torno a área mais importante da imagem. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/describe/action | Essa operação gera uma descrição de uma imagem em uma linguagem legível humana com frases completas.<br> A descrição é com base em uma coleção de marcas de conteúdo, que também são retornados pela operação.<br>Mais de uma descrição pode ser gerada para cada imagem.<br> As descrições são ordenadas pela pontuação de confiança.<br>Todas as descrições são em inglês. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/detect/action | Essa detecção de objeto operação realiza na imagem especificada.  |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/generatethumbnail/action | Essa operação gera uma imagem em miniatura com a altura e largura especificadas pelo usuário.<br> Por padrão, o serviço analisa a imagem, identifica a região de interesse (ROI) e gera as coordenadas de corte inteligentes com base no ROI.<br> Corte inteligente ajuda quando você especificar uma taxa de proporção diferente da imagem de entrada |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/models/analyze/action | Esta operação reconhece o conteúdo dentro de uma imagem, aplicando um modelo de domínio específico.<br> A lista de modelos específicos de domínio que são compatíveis com a API de visão do computador pode ser recuperada usando a solicitação de obtenção de /models.<br> Atualmente, a API fornece modelos específicos de domínio a seguir: celebridades, pontos de referência. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/models/read | Essa operação retorna a lista de modelos específicos de domínio que são compatíveis com a API de visão do computador.  Atualmente, a API dá suporte a modelos específicos de domínio a seguir: reconhecimento de celebridades, reconhecedor de pontos de referência. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/ocr/action | Reconhecimento óptico de caracteres (OCR) detecta textos em uma imagem e extrai os caracteres reconhecidos para um fluxo de caracteres utilizável de máquina.    |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/recognizetext/action | Use esta interface para obter o resultado de uma operação de reconhecer texto. Quando você usa a interface de reconhecer texto, a resposta contém um campo chamado "Operation-Location". O campo "Operation-Location" contém a URL que você deve usar para a operação obter resultado da operação texto reconhecer. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/tag/action | Essa operação gera uma lista de palavras ou marcas, que são relevantes para o conteúdo da imagem fornecido.<br>A API da pesquisa Visual computacional pode retornar marcas com base em objetos, vivendo seres, cenários ou ações encontradas nas imagens.<br>Ao contrário de categorias, marcas não são organizadas de acordo com a um sistema de classificação hierárquica, mas correspondem ao conteúdo de imagem.<br>As marcas podem conter dicas para evitar ambiguidade ou fornecer contexto, por exemplo o cello"marca" pode ser acompanhada pela dica "instrumento musical".<br>Todas as marcas estão em inglês. |
> | DataAction | Microsoft.CognitiveServices/accounts/ComputerVision/textoperations/read | Essa interface é usada para obtenção de reconhecer o resultado da operação de texto. A URL para essa interface deve ser recuperada da <b>"Operation-Location"</b> campo retornado na interface de reconhecer texto. |
> | Ação | Microsoft.CognitiveServices/accounts/delete | Excluir contas de API |
> | DataAction | Microsoft.CognitiveServices/accounts/Face/detect/action | Detecte rostos humanos em uma imagem, retângulos de face de retorno e, opcionalmente, com faceIds, pontos de referência e atributos. |
...
> | DataAction | Microsoft.CognitiveServices/accounts/TextAnalytics/entities/action | A API retorna uma lista de entidades conhecidas e geral entidades nomeadas (\"pessoa\", \"local\", \"organização\" etc) em um determinado documento. |
...
> | Ação | Microsoft.Compute/hostGroups/write | Cria um novo grupo de hosts ou atualiza um grupo de host existente |
> | Ação | Microsoft.Compute/hosts/delete | Exclui o host |
> | Ação | Microsoft.Compute/hosts/read | Obter as propriedades de um host |
> | Ação | Microsoft.Compute/hosts/write | Cria um novo host ou atualiza um host existente |
...
> | Ação | Microsoft.Compute/virtualMachineScaleSets/vmSizes/read | Lista de tamanhos disponíveis para criar ou atualizar uma máquina virtual no conjunto de dimensionamento de máquina Virtual |
...
> | Ação | Microsoft.Consumption/tenants/read | Locatários de lista |
...
> | Ação | Microsoft.ContainerService/managedClusters/agentPools/read | Obtém um pool de agentes |
> | Ação | Microsoft.ContainerService/managedClusters/agentPools/write | Cria um novo pool de agente ou atualiza uma existente |
...
> | Ação | Microsoft.ContainerService/openShiftClusters/delete | Excluir um Cluster de Open Shift |
> | Ação | Microsoft.ContainerService/openShiftClusters/read | Obtém um Cluster do Open Shift |
> | Ação | Microsoft.ContainerService/openShiftClusters/write | Cria um novo Open Shift Cluster ou atualiza um já existente |
> | Ação | Microsoft.ContainerService/openShiftManagedClusters/delete | Excluir um Cluster gerenciado de Open Shift |
> | Ação | Microsoft.ContainerService/openShiftManagedClusters/read | Obtenha um Cluster gerenciado de Open Shift |
...
> | Tipo de ação | Operação | DESCRIÇÃO |
> | --- | --- | --- |
> | Ação | Microsoft.CostManagement/cloudConnectors/delete | Exclua o cloudConnector especificado. |
...
> | Ação | Microsoft.CostManagement/externalBillingAccounts/externalSubscriptions/read | Liste o externalSubscriptions dentro de um externalBillingAccount para o usuário autenticado. |
...
> | Ação | Microsoft.CostManagement/externalSubscriptions/write | Atualizar grupo de gerenciamento associado do externalSubscription |
...
> | Ação | Microsoft.CostManagement/register/action | Registre-se a ação de escopo do Microsoft.CostManagement por uma assinatura. |
...
> | Ação | Microsoft.CostManagement/tenants/register/action | Registre-se a ação de escopo do Microsoft.CostManagement por um locatário. |
...
> | Ação | Microsoft.Databricks/workspaces/providers/Microsoft.Insights/diagnosticSettings/read | Define as configurações de diagnóstico disponíveis para o espaço de trabalho Databricks |
...
> | Tipo de ação | Operação | DESCRIÇÃO |
> | --- | --- | --- |
> | Ação | Microsoft.DataCatalog/catalogs/delete | Exclua o recurso de catálogos para provedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/catalogs/read | Ler o recurso de catálogos para provedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/catalogs/write | Gravar o recurso de catálogos para provedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/checkNameAvailability/read | Verificar disponibilidade do nome de catálogo para o provedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/datacatalogs/delete | Exclua o recurso de DataCatalog para provedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/datacatalogs/read | Ler recurso DataCatalog para provedor de recursos do catálogo de dados. |
> | Ação | Microsoft.DataCatalog/datacatalogs/write | Escreva DataCatalog recursos para o provedor de recursos do catálogo de dados. |
...
> | Ação | Microsoft.DataCatalog/unregister/action | Cancelar o registro de assinatura para o provedor de recursos do catálogo de dados |
...
> | Ação | Microsoft.DataLakeAnalytics/accounts/virtualNetworkRules/delete | Exclua uma regra de rede virtual. |
...
> | Ação | Microsoft.DataLakeStore/accounts/virtualNetworkRules/delete | Exclua uma regra de rede virtual. |
...
> | Ação | Microsoft.DataMigration/services/addWorker/action | Adiciona um trabalho do DMS aos trabalhos disponíveis do Serviço |
> | Ação | Microsoft.DataMigration/services/checkStatus/action | Verificar se o serviço está implantado e em execução |
> | Ação | Microsoft.DataMigration/services/configureWorker/action | Configura um trabalho do DMS para os trabalhos disponíveis do Serviço |
...
> | Ação | Microsoft.DataMigration/services/removeWorker/action | Remove um trabalho do DMS dos trabalhos disponíveis do Serviço |
...
> | Ação | Microsoft.DBforMariaDB/locations/azureAsyncOperation/read | Retornar resultados da operação de servidor MariaDB |
> | Ação | Microsoft.DBforMariaDB/locations/operationResults/read | Retorno do grupo de recursos com base em resultados da operação de servidor MariaDB |
> | Ação | Microsoft.DBforMariaDB/locations/operationResults/read | Retornar resultados da operação de servidor MariaDB |
> | Ação | Microsoft.DBforMariaDB/locations/performanceTiers/read | Retornar a lista de Níveis de Desempenho disponíveis. |
> | Ação | Microsoft.DBforMariaDB/locations/securityAlertPoliciesAzureAsyncOperation/read | Retorne a lista de resultado da operação de detecção do servidor contra ameaças. |
> | Ação | Microsoft.DBforMariaDB/locations/securityAlertPoliciesOperationResults/read | Retorne a lista de resultado da operação de detecção do servidor contra ameaças. |
> | Ação | Microsoft.DBforMariaDB/operations/read | Retorne a lista de operações do MariaDB. |
> | Ação | Microsoft.DBforMariaDB/performanceTiers/read | Retornar a lista de Níveis de Desempenho disponíveis. |
> | Ação | Microsoft.DBforMariaDB/register/action | Registrar provedor de recursos do MariaDB |
> | Ação | Microsoft.DBforMariaDB/servers/administrators/delete | Exclui um administrador existente do servidor do MariaDB. |
...
> | Ação | Microsoft.DBforMariaDB/servers/databases/delete | Exclui um banco de dados existente do MariaDB. |
> | Ação | Microsoft.DBforMariaDB/servers/databases/read | Retorna a lista de bancos de dados do MariaDB ou obter as propriedades para o banco de dados especificado. |
> | Ação | Microsoft.DBforMariaDB/servers/databases/write | Cria um banco de dados do MariaDB com os parâmetros especificados ou atualizar as propriedades de banco de dados especificado. |
...
> | Ação | Microsoft.DBforMariaDB/servers/logFiles/read | Retorne a lista de MariaDB LogFiles. |
...
> | Ação | Microsoft.DBforMariaDB/servers/queryTexts/action | Retornar os textos para obter uma lista de consultas |
...
> | Ação | Microsoft.DBforMariaDB/servers/replicas/read | Obter ler as réplicas de um servidor MariaDB |
...
> | Ação | Microsoft.DBforMySQL/locations/azureAsyncOperation/read | Retornar resultados de operação do servidor MySQL |
> | Ação | Microsoft.DBforMySQL/locations/operationResults/read | Retorno do grupo de recursos com base em resultados de operação do servidor MySQL |
> | Ação | Microsoft.DBforMySQL/locations/operationResults/read | Retornar resultados de operação do servidor MySQL |
> | Ação | Microsoft.DBforMySQL/locations/performanceTiers/read | Retornar a lista de Níveis de Desempenho disponíveis. |
> | Ação | Microsoft.DBforMySQL/locations/securityAlertPoliciesAzureAsyncOperation/read | Retorne a lista de resultado da operação de detecção do servidor contra ameaças. |
> | Ação | Microsoft.DBforMySQL/locations/securityAlertPoliciesOperationResults/read | Retorne a lista de resultado da operação de detecção do servidor contra ameaças. |
> | Ação | Microsoft.DBforMySQL/operations/read | Retorne a lista de operações do MySQL. |
> | Ação | Microsoft.DBforMySQL/performanceTiers/read | Retornar a lista de Níveis de Desempenho disponíveis. |
> | Ação | Microsoft.DBforMySQL/register/action | Registrar provedor de recursos do MySQL |
...
> | Ação | Microsoft.DBforMySQL/servers/databases/read | Retorna a lista de bancos de dados MySQL ou obter as propriedades para o banco de dados especificado. |
> | Ação | Microsoft.DBforMySQL/servers/databases/write | Cria um banco de dados MySQL com os parâmetros especificados ou atualizar as propriedades de banco de dados especificado. |
...
> | Ação | Microsoft.DBforMySQL/servers/logFiles/read | Retorne a lista de PostgreSQL LogFiles. |
...
> | Ação | Microsoft.DBforMySQL/servers/queryTexts/action | Retornar os textos para obter uma lista de consultas |
...
> | Ação | Microsoft.DBforMySQL/servers/replicas/read | Obter ler as réplicas de um servidor MySQL |
...
> | Ação | Microsoft.DBforPostgreSQL/locations/azureAsyncOperation/read | Retornar resultados de operação do servidor PostgreSQL |
> | Ação | Microsoft.DBforPostgreSQL/locations/operationResults/read | Retorno do grupo de recursos com base em resultados de operação do servidor PostgreSQL |
> | Ação | Microsoft.DBforPostgreSQL/locations/operationResults/read | Retornar resultados de operação do servidor PostgreSQL |
> | Ação | Microsoft.DBforPostgreSQL/locations/performanceTiers/read | Retornar a lista de Níveis de Desempenho disponíveis. |
> | Ação | Microsoft.DBforPostgreSQL/locations/securityAlertPoliciesAzureAsyncOperation/read | Retorne a lista de resultado da operação de detecção do servidor contra ameaças. |
> | Ação | Microsoft.DBforPostgreSQL/locations/securityAlertPoliciesOperationResults/read | Retorne a lista de resultado da operação de detecção do servidor contra ameaças. |
> | Ação | Microsoft.DBforPostgreSQL/operations/read | Retorne a lista de operações do PostgreSQL. |
> | Ação | Microsoft.DBforPostgreSQL/performanceTiers/read | Retornar a lista de Níveis de Desempenho disponíveis. |
> | Ação | Microsoft.DBforPostgreSQL/register/action | Registrar provedor de recursos do PostgreSQL |
...
> | Ação | Microsoft.DBforPostgreSQL/servers/databases/read | Retorna a lista de bancos de dados PostgreSQL ou obter as propriedades para o banco de dados especificado. |
> | Ação | Microsoft.DBforPostgreSQL/servers/databases/write | Cria um banco de dados PostgreSQL com os parâmetros especificados ou atualizar as propriedades de banco de dados especificado. |
...
> | Ação | Microsoft.DBforPostgreSQL/servers/logFiles/read | Retorne a lista de PostgreSQL LogFiles. |
...
> | Ação | Microsoft.DBforPostgreSQL/servers/queryTexts/read | Retornar os textos para obter uma lista de consultas |
...
> | Ação | Microsoft.DBforPostgreSQL/servers/replicas/read | Obter leitura a réplicas de um servidor PostgreSQL |
...
> | Ação | Microsoft.DevSpaces/locations/checkContainerHostMapping/action | Verifique o mapeamento de controlador existente para um host do contêiner |
> | Ação | Microsoft.DevSpaces/locations/operationresults/read | Status de leitura para uma operação assíncrona |
...
> | Ação | Microsoft.DevTestLab/labs/EnsureCurrentUserProfile/action | Certifique-se de que o usuário atual tem um perfil válido no laboratório. |
...
> | Ação | Microsoft.DevTestLab/labs/idleShutdowns/delete | Exclua desligamentos ociosos. |
> | Ação | Microsoft.DevTestLab/labs/idleShutdowns/read | Leia os desligamentos ociosos. |
> | Ação | Microsoft.DevTestLab/labs/idleShutdowns/write | Adicionar ou modificar os desligamentos ociosos. |
...
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/delete | Exclua galerias compartilhadas. |
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/read | Leitura compartilhada galerias. |
> | Ação | Microsoft.DevTestLab/labs/sharedGalleries/sharedImages/delete | Exclua imagens compartilhadas. |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/delete | Exclua uma coleção. Aplicável somente para tipos de API: 'mongodb'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'mongodb'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/read | Ler uma coleção ou lista todas as coleções. Aplicável somente para tipos de API: 'mongodb'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'mongodb'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/read | Leia uma taxa de transferência da coleção. Aplicável somente para tipos de API: 'mongodb'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/settings/write | Atualize uma taxa de transferência da coleção. Aplicável somente para tipos de API: 'mongodb'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/collections/write | Criar ou atualizar uma coleção. Aplicável somente para tipos de API: 'mongodb'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/delete | Exclua um contêiner. Aplicável somente para tipos de API: 'sql'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'sql'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/read | Ler um contêiner ou listar todos os contêineres. Aplicável somente para tipos de API: 'sql'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'sql'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/read | Leia uma taxa de transferência do contêiner. Aplicável somente para tipos de API: 'sql'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/settings/write | Atualize uma taxa de transferência do contêiner. Aplicável somente para tipos de API: 'sql'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/containers/write | Criar ou atualizar um contêiner. Aplicável somente para tipos de API: 'sql'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/delete | Exclua um banco de dados. Aplicável somente para tipos de API: 'sql', 'mongodb', 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/delete | Exclua um gráfico. Aplicável somente para tipos de API: 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/read | Ler um gráfico ou lista todos os gráficos. Aplicável somente para tipos de API: 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'gremlin'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/read | Leia uma taxa de transferência de gráfico. Aplicável somente para tipos de API: 'gremlin'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/settings/write | Atualize uma taxa de transferência de gráfico. Aplicável somente para tipos de API: 'gremlin'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/graphs/write | Criar ou atualizar um gráfico. Aplicável somente para tipos de API: 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'sql', 'mongodb', 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/read | Ler um banco de dados ou listar todos os bancos de dados. Aplicável somente para tipos de API: 'sql', 'mongodb', 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'sql', 'mongodb', 'gremlin'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/read | Leia uma taxa de transferência de banco de dados. Aplicável somente para tipos de API: 'sql', 'mongodb', 'gremlin'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/settings/write | Atualize uma taxa de transferência de banco de dados. Aplicável somente para tipos de API: 'sql', 'mongodb', 'gremlin'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/databases/write | Criar um banco de dados. Aplicável somente para tipos de API: 'sql', 'mongodb', 'gremlin'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/delete | Exclua um keyspace. Aplicável somente para tipos de API: 'cassandra'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'cassandra'. |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'cassandra'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/read | Leia uma taxa de transferência de keyspace. Aplicável somente para tipos de API: 'cassandra'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/settings/write | Atualize uma taxa de transferência de keyspace. Aplicável somente para tipos de API: 'cassandra'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'cassandra'. |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'cassandra'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/read | Leia uma taxa de transferência de tabela. Aplicável somente para tipos de API: 'cassandra'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/keyspaces/tables/settings/write | Atualize uma taxa de transferência de tabela. Aplicável somente para tipos de API: 'cassandra'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'table'. |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/operationResults/read | Ler o status da operação assíncrona. Aplicável somente para tipos de API: 'table'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/read | Leia uma taxa de transferência de tabela. Aplicável somente para tipos de API: 'table'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/settings/write | Atualize uma taxa de transferência de tabela. Aplicável somente para tipos de API: 'table'. Aplicável somente para definir os tipos: 'taxa de transferência'. |
> | Ação | Microsoft.DocumentDB/databaseAccounts/apis/tables/write | Criar ou atualizar uma tabela. Aplicável somente para tipos de API: 'table'. |
...
> | Ação | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/delete | Excluir um proxy de conexão do ponto de extremidade privado da conta de banco de dados |
> | Ação | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/read | Ler um proxy de conexão do ponto de extremidade privado da conta de banco de dados |
> | Ação | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/validate/action | Validar um proxy de conexão do ponto de extremidade privado da conta de banco de dados |
> | Ação | Microsoft.DocumentDB/databaseAccounts/privateEndpointConnectionProxies/write | Criar ou atualizar um proxy de conexão do ponto de extremidade privado da conta de banco de dados |
...
> | Ação | Microsoft.DocumentDB/locations/operationsStatus/read | Lê o Status das operações assíncronas |
...
> | Tipo de ação | Operação | DESCRIÇÃO |
> | --- | --- | --- |
> | Ação | Microsoft.EventHub/availableClusterRegions/read | Listar clusters pré-provisionados disponíveis por região do Azure da operação de leitura. |
...
> | Ação | Microsoft.EventHub/clusters/namespaces/read | IDs de ARM de namespace de lista para namespaces dentro de um cluster. |
> | Ação | Microsoft.EventHub/clusters/operationresults/read | Obter o status de uma operação assíncrona de cluster. |
...
> | Tipo de ação | Operação | DESCRIÇÃO |
> | --- | --- | --- |
> | Ação | Microsoft.GuestConfiguration/guestConfigurationAssignments/delete | Exclua atribuição de configuração do convidado. |
...
> | Ação | Microsoft.GuestConfiguration/register/action | Registra a assinatura do provedor de recursos Microsoft.GuestConfiguration. |
...
> | Ação | Microsoft.HDInsight/clusters/getGatewaySettings/action | Obter configurações de gateway para Cluster do HDInsight |
...
> | Ação | Microsoft.HDInsight/clusters/updateGatewaySettings/action | Atualizar as configurações de gateway para Cluster do HDInsight |
...
> | Ação | Microsoft.Insights/CalculateBaseline/Read | Calcular a linha de base dos valores de métrica (versão prévia) |
...
> | Ação | Microsoft.Insights/MetricBaselines/Read | Ler as linhas de base de métrica |
...
> | Ação | Microsoft.KeyVault/vaults/eventGridFilters/delete | Notifica o Microsoft.KeyVault que uma assinatura EventGrid para o Key Vault está sendo excluída |
> | Ação | Microsoft.KeyVault/vaults/eventGridFilters/read | Notifica o Microsoft.KeyVault que uma assinatura EventGrid para o Key Vault está sendo exibida |
> | Ação | Microsoft.KeyVault/vaults/eventGridFilters/write | Notifica o Microsoft.KeyVault que está sendo criada uma nova assinatura EventGrid para o Key Vault |
...
> | Ação | Microsoft.Kusto/Clusters/Databases/AddPrincipals/action | Adiciona as entidades de banco de dados. |
> | Ação | Microsoft.Kusto/Clusters/Databases/CheckNameAvailability/action | Verifica a disponibilidade do nome para um determinado tipo. |
...
> | Ação | Microsoft.Kusto/Clusters/Databases/DataConnectionValidation/action | Valida a conexão de dados do banco de dados. |
...
> | Ação | Microsoft.Kusto/Clusters/Databases/EventHubConnectionValidation/action | Valida a conexão do Hub de eventos de banco de dados. |
> | Ação | Microsoft.Kusto/Clusters/Databases/ListPrincipals/action | Listas de entidades de segurança de banco de dados. |
> | Ação | Microsoft.Kusto/Clusters/Databases/read | Lê um recurso de banco de dados. |
> | Ação | Microsoft.Kusto/Clusters/Databases/RemovePrincipals/action | Remove as entidades de banco de dados. |
...
> | Ação | Microsoft.Kusto/Clusters/Start/action | Inicia o cluster. |
...
> | Ação | Microsoft.Kusto/Register/action | Registra a assinatura para o provedor de recursos do Kusto. |
> | Ação | Microsoft.Kusto/SKUs/read | Lê um recurso SKU. |
> | Ação | Microsoft.Kusto/Unregister/action | Cancelar a assinatura para o provedor de recursos do Kusto. |
...
> | Ação | Microsoft.LabServices/labAccounts/labs/environmentSettings/ResetPassword/action | Redefine a senha na máquina virtual de modelo. |
> | Ação | Microsoft.LabServices/labAccounts/labs/environmentSettings/SaveImage/action | Salva a imagem de modelo atual para a Galeria compartilhada na conta de laboratório |
...
> | Ação | Microsoft.LabServices/users/ListAllEnvironments/action | Listar todos os ambientes para o usuário |
...
> | DataAction | Microsoft.MachineLearningServices/workspaces/experiments/write | Cria ou atualiza experimentos nos espaços de trabalho do Machine Learning Services |
...
> | Ação | Microsoft.Maps/operations/read | O provedor de operações de leitura |
...
> | Ação | Microsoft.MarketplaceOrdering/operations/read | Listar todas as possíveis operações na API |
...
> | Ação | Microsoft.Migrate/assessmentprojects/delete | Exclui o projeto de avaliação |
...
> | Ação | Microsoft.Migrate/assessmentprojects/groups/updateMachines/action | Grupo de atualização, adicionando ou removendo máquinas |
> | Ação | Microsoft.Migrate/assessmentprojects/groups/write | Cria um novo grupo ou atualiza um grupo existente |
> | Ação | Microsoft.Migrate/assessmentprojects/hypervcollectors/delete | Exclui o coletor do Hyper-v |
> | Ação | Microsoft.Migrate/assessmentprojects/hypervcollectors/read | Obtém as propriedades do coletor do Hyper-v |
> | Ação | Microsoft.Migrate/assessmentprojects/hypervcollectors/write | Criar um novo coletor de Hyper-v ou atualizar um coletor do Hyper-v existente |
...
> | Ação | Microsoft.Migrate/assessmentprojects/vmwarecollectors/delete | Exclui o coletor de VMware |
> | Ação | Microsoft.Migrate/assessmentprojects/vmwarecollectors/read | Obtém as propriedades do coletor de VMware |
> | Ação | Microsoft.Migrate/assessmentprojects/vmwarecollectors/write | Cria um novo coletor de VMware ou atualiza um coletor de VMware existente |
> | Ação | Microsoft.Migrate/assessmentprojects/write | Cria um novo projeto de avaliação ou atualizar um projeto existente de avaliação |
...
> | Ação | Microsoft.Migrate/migrateprojects/delete | Exclui um projeto de migração |
...
> | Ação | Microsoft.Migrate/migrateprojects/MigrateEvents/read | Obtém as propriedades de uma migração de eventos. |
> | Ação | Microsoft.Migrate/migrateprojects/read | Obtém as propriedades do projeto de migração |
> | Ação | Microsoft.Migrate/migrateprojects/registerTool/action | Ferramenta de registros a um projeto de migração |
> | Ação | Microsoft.Migrate/migrateprojects/solutions/cleanupData/action | Limpar os dados de solução de projeto de migrações |
> | Ação | Microsoft.Migrate/migrateprojects/solutions/Delete | Exclui uma solução de projeto de migração |
...
> | Ação | Microsoft.Migrate/migrateprojects/solutions/write | Cria uma nova solução de projeto de migração ou atualiza uma solução de projeto de migração existente |
> | Ação | Microsoft.Migrate/migrateprojects/write | Cria um novo projeto de migrações ou atualiza um projeto de migração existente |
...
> | DataAction | Microsoft.MixedReality/SpatialAnchorsAccounts/delete | Excluir as âncoras espaciais |
> | DataAction | Microsoft.MixedReality/SpatialAnchorsAccounts/discovery/read | Descobrir as próximas âncoras espaciais |
> | DataAction | Microsoft.MixedReality/SpatialAnchorsAccounts/properties/read | Obter propriedades espaciais âncoras |
...
> | DataAction | Microsoft.MixedReality/SpatialAnchorsAccounts/submitdiag/read | Enviar dados de diagnóstico para ajudar a melhorar a qualidade do serviço âncoras espacial do Azure |
> | DataAction | Microsoft.MixedReality/SpatialAnchorsAccounts/write | Atualizar propriedades espaciais âncoras |
...
> | Ação | Microsoft.Network/applicationGateways/backendAddressPools/join/action | Une um pool de endereços de back-end de gateway de aplicativo. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/delete | Exclui uma política do WAF do Gateway de aplicativo |
> | Ação | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/read | Obtém uma política do WAF do Gateway de aplicativo |
> | Ação | Microsoft.Network/ApplicationGatewayWebApplicationFirewallPolicies/write | Cria uma política do WAF do Gateway de aplicativo ou atualizar uma política do WAF do Gateway de aplicativo |
> | Ação | Microsoft.Network/applicationSecurityGroups/delete | Excluir um grupo de segurança de aplicativo |
> | Ação | Microsoft.Network/applicationSecurityGroups/joinIpConfiguration/action | Adicionar uma configuração IP aos grupos de segurança de aplicativo. Não podem gerar alertas. |
> | Ação | Microsoft.Network/applicationSecurityGroups/joinNetworkSecurityRule/action | Adicionar uma regra de segurança aos grupos de segurança de aplicativo. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/ddosProtectionPlans/join/action | Une um plano de proteção contra DDoS. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/expressRouteCircuits/join/action | Une um circuito do Expressroute. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/expressRouteCrossConnections/join/action | Adicionar uma rota expressa cruzar a Conexão. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/expressRouteGateways/join/action | Une um Gateway de rota expressa. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/expressRoutePorts/join/action | Une as portas de rota expressa. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/frontDoorWebApplicationFirewallManagedRuleSets/read | Firewall do aplicativo Web obtém gerenciados conjuntos de regras |
...
> | Ação | Microsoft.Network/loadBalancers/backendAddressPools/join/action | Une um pool de endereços de back-end de Balanceador de carga. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/loadBalancers/frontendIPConfigurations/join/action | Une uma configuração de IP de front-end do balanceador de carga. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/loadBalancers/inboundNatPools/join/action | Une um balanceador de carga pool NAT de entrada. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/loadBalancers/inboundNatRules/join/action | Une uma regra de nat de entrada do balanceador de carga. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/loadBalancers/probes/join/action | Permite usar investigações de um balanceador de carga. Por exemplo, com essa permissão, a propriedade healthProbe do conjunto de dimensionamento de VM pode referenciar a investigação. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/locations/autoApprovedPrivateLinkServices/read | Obtém automaticamente aprovadas privada vincular serviços |
> | Ação | Microsoft.Network/locations/availableDelegations/read | Obtém as delegações disponíveis |
> | Ação | Microsoft.Network/locations/availablePrivateEndpointTypes/read | Obtém o ponto de extremidade privados disponível de recursos |
...
> | Ação | Microsoft.Network/locations/checkPrivateLinkServiceVisibility/action | Verificações de visibilidade de serviço de vinculação particular |
...
> | Ação | Microsoft.Network/networkInterfaces/ipconfigurations/join/action | Une uma configuração IP do adaptador de rede. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/networkInterfaces/join/action | Adicionar uma máquina Virtual a um adaptador de rede. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/networkSecurityGroups/join/action | Une um grupo de segurança de rede. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/privateDnsOperationResults/read | Obtém os resultados de um DNS privado da operação |
> | Ação | Microsoft.Network/privateDnsOperationStatuses/read | Obtém o status de um DNS privado da operação |
> | Ação | Microsoft.Network/privateDnsZones/A/delete | Remover o conjunto de registros de determinado nome e tipo 'A' de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/A/read | Obter o conjunto de registros do tipo 'A' dentro de uma zona DNS privado, no formato JSON. O conjunto de registros contém uma lista de registros, o TTL, as marcações e as etags. |
> | Ação | Microsoft.Network/privateDnsZones/A/write | Criar ou atualizar um conjunto de registros do tipo 'A' dentro de uma zona DNS privado. Os registros especificados substituirão os registros atuais no conjunto de registros. |
> | Ação | Microsoft.Network/privateDnsZones/AAAA/delete | Remover o conjunto de registros de determinado nome e tipo 'AAAA' de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/AAAA/read | Obter o conjunto de registros do tipo 'AAAA' dentro de uma zona DNS privado, no formato JSON. O conjunto de registros contém uma lista de registros, o TTL, as marcações e as etags. |
> | Ação | Microsoft.Network/privateDnsZones/AAAA/write | Criar ou atualizar um conjunto de registros do tipo 'AAAA' em uma zona de DNS privado. Os registros especificados substituirão os registros atuais no conjunto de registros. |
> | Ação | Microsoft.Network/privateDnsZones/ALL/read | Obtém os conjuntos de registros de DNS privado em todos os tipos |
> | Ação | Microsoft.Network/privateDnsZones/CNAME/delete | Remover o conjunto de registros de determinado nome e tipo 'CNAME' de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/CNAME/read | Obter o conjunto de registros do tipo 'CNAME' dentro de uma zona DNS privado, no formato JSON. |
> | Ação | Microsoft.Network/privateDnsZones/CNAME/write | Criar ou atualizar um conjunto de registros do tipo 'CNAME' em uma zona de DNS privado. |
> | Ação | Microsoft.Network/privateDnsZones/delete | Exclua uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/MX/delete | Remover o conjunto de registros de determinado nome e tipo 'MX' de uma zona DNS privado. |
> | Ação | Microsoft.Network/privateDnsZones/MX/read | Obter o conjunto de registros do tipo 'MX' dentro de uma zona DNS privado, no formato JSON. O conjunto de registros contém uma lista de registros, o TTL, as marcações e as etags. |
> | Ação | Microsoft.Network/privateDnsZones/MX/write | Criar ou atualizar um conjunto de registros do tipo 'MX' em uma zona de DNS privado. Os registros especificados substituirão os registros atuais no conjunto de registros. |
> | Ação | Microsoft.Network/privateDnsZones/PTR/delete | Remover o conjunto de registros de determinado nome e tipo 'PTR' de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/PTR/read | Obter o conjunto de registros do tipo 'PTR' dentro de uma zona DNS privado, no formato JSON. O conjunto de registros contém uma lista de registros, o TTL, as marcações e as etags. |
> | Ação | Microsoft.Network/privateDnsZones/PTR/write | Criar ou atualizar um conjunto de registros do tipo 'PTR' em uma zona de DNS privado. Os registros especificados substituirão os registros atuais no conjunto de registros. |
> | Ação | Microsoft.Network/privateDnsZones/read | Obter propriedades da zona, de DNS privada no formato JSON. Observe que esse comando não recupera as redes virtuais ao qual a zona DNS privado está vinculada ou os conjuntos de registros contidos na zona. |
> | Ação | Microsoft.Network/privateDnsZones/recordsets/read | Obtém os conjuntos de registros de DNS privado em todos os tipos |
> | Ação | Microsoft.Network/privateDnsZones/SOA/read | Obter o conjunto de registros do tipo SOA dentro de uma zona DNS privado, no formato JSON. |
> | Ação | Microsoft.Network/privateDnsZones/SOA/write | Atualize um conjunto de registros do tipo 'SOA' dentro de uma zona DNS privado. |
> | Ação | Microsoft.Network/privateDnsZones/SRV/delete | Remover o conjunto de registros de determinado nome e tipo 'SRV' de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/SRV/read | Obter o conjunto de registros do tipo 'SRV' dentro de uma zona DNS privado, no formato JSON. O conjunto de registros contém uma lista de registros, o TTL, as marcações e as etags. |
> | Ação | Microsoft.Network/privateDnsZones/SRV/write | Criar ou atualizar um conjunto de registros do tipo 'SRV' em uma zona de DNS privado. Os registros especificados substituirão os registros atuais no conjunto de registros. |
> | Ação | Microsoft.Network/privateDnsZones/TXT/delete | Remover o conjunto de registros de determinado nome e tipo 'TXT' de uma zona DNS privada. |
> | Ação | Microsoft.Network/privateDnsZones/TXT/read | Obter o conjunto de registros do tipo 'TXT' dentro de uma zona DNS privado, no formato JSON. O conjunto de registros contém uma lista de registros, o TTL, as marcações e as etags. |
> | Ação | Microsoft.Network/privateDnsZones/TXT/write | Criar ou atualizar um conjunto de registros do tipo 'TXT' em uma zona de DNS privado. Os registros especificados substituirão os registros atuais no conjunto de registros. |
> | Ação | Microsoft.Network/privateDnsZones/virtualNetworkLinks/delete | Exclua um link de zona DNS privada com rede virtual. |
> | Ação | Microsoft.Network/privateDnsZones/virtualNetworkLinks/read | Obter o DNS privado link de zona para propriedades de rede virtual, no formato JSON. |
> | Ação | Microsoft.Network/privateDnsZones/virtualNetworkLinks/write | Criar ou atualizar um link de zona DNS privada com rede virtual. |
> | Ação | Microsoft.Network/privateDnsZones/write | Criar ou atualizar uma zona DNS privada dentro de um grupo de recursos. Observe que esse comando não pode ser usado para criar ou atualizar links de rede virtual ou conjuntos de registros dentro da zona. |
...
> | Ação | Microsoft.Network/privateLinkServices/privateEndpointConnections/read | Obtém uma definição de conexão do ponto de extremidade privado. |
> | Ação | Microsoft.Network/privateLinkServices/privateEndpointConnections/write | Cria uma nova conexão de ponto de extremidade privado ou atualiza uma conexão privada do ponto de extremidade existente. |
...
> | Ação | Microsoft.Network/publicIPAddresses/join/action | Une um endereço ip público. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/publicIPPrefixes/join/action | Une um PublicIPPrefix. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/routeFilters/join/action | Une um filtro de rota. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/routeTables/join/action | Une uma tabela de rotas. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/serviceEndpointPolicies/join/action | Une uma política de ponto de extremidade de serviço. Não podem gerar alertas. |
> | Ação | Microsoft.Network/serviceEndpointPolicies/joinSubnet/action | Adicionar uma sub-rede para políticas de ponto de extremidade de serviço. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/virtualNetworks/subnets/join/action | Une a uma rede virtual. Não podem gerar alertas. |
> | Ação | Microsoft.Network/virtualNetworks/subnets/joinViaServiceEndpoint/action | Adicionar recursos como conta de armazenamento ou banco de dados SQL a uma sub-rede. Não podem gerar alertas. |
...
> | Ação | Microsoft.Network/virtualNetworkTaps/join/action | Une um toque de rede virtual. Não podem gerar alertas. |
...
> | Ação | Microsoft.OffAzure/HyperVSites/machines/start/action | Inicia computadores do Hyper-V |
...
> | Ação | Microsoft.PolicyInsights/operations/read | Obtém operações com suporte em namespace policyinsights |
...
> | Ação | Microsoft.PolicyInsights/register/action | Registra o provedor de recursos de informações de política da Microsoft e permite ações nele. |
> | Ação | Microsoft.PolicyInsights/remediations/cancel/action | Cancele as correções de Policy da Microsoft em andamento. |
...
> | Ação | Microsoft.PolicyInsights/remediations/write | Criar ou atualizar correções Policy da Microsoft. |
> | Ação | Microsoft.PolicyInsights/unregister/action | Cancela o registro do provedor de recursos de informações de política da Microsoft. |
...
> | Ação | Microsoft.Portal/consoles/write | Crie ou atualize uma instância do Cloud Shell. |
...
> | Ação | Microsoft.Portal/usersettings/write | Crie ou atualize as configurações de usuário do Cloud Shell. |
...
> | Ação | Microsoft.Resources/tags/write | Atualiza as marcas em um recurso, substituir ou mesclar marcas existentes com um novo conjunto de marcas ou removendo as marcas existentes. |
...
> | Tipo de ação | Operação | DESCRIÇÃO |
> | --- | --- | --- |
> | Ação | Microsoft.Security/adaptiveNetworkHardenings/enforce/action | Impõe o tráfego de determinado sistema de proteção de regras, criando regras de segurança correspondente no determinado grupo de segurança de rede |
...
> | DataAction | Microsoft.ServiceBus/namespaces/messages/browse/action | Procurar mensagens |
...
> | DataAction | Microsoft.ServiceBus/namespaces/messages/setstate/action | Definir estado de sessão |
...
> | Ação | Microsoft.SignalRService/SignalR/eventGridFilters/delete | Exclua um filtro de grade de eventos de um SignalR. |
> | Ação | Microsoft.SignalRService/SignalR/eventGridFilters/read | Obtenha as propriedades do filtro de grade de eventos especificado ou listas de filtros de grade de eventos para o SignalR especificado. |
> | Ação | Microsoft.SignalRService/SignalR/eventGridFilters/write | Criar ou atualizar um filtro de grade de eventos para um SignalR com os parâmetros especificados. |
...
> | Ação | Microsoft.Solutions/applications/refreshPermissions/action | Atualiza as permissões de aplicativo. |
> | Ação | Microsoft.Solutions/applications/updateAccess/action | Atualiza o acesso de aplicativo. |
...
> | Ação | Microsoft.Sql/instancePools/usages/read | Obtém informações sobre o uso do pool de uma instância |
...
> | Ação | Microsoft.Sql/locations/encryptionProtectorAzureAsyncOperation/read | Obtém de operações em protetor da transparent data encryption criptografia em andamento |
> | Ação | Microsoft.Sql/locations/encryptionProtectorOperationResults/read | Obtém de operações em protetor da transparent data encryption criptografia em andamento |
...
> | Ação | Microsoft.Sql/locations/instanceFailoverGroups/write | Cria um grupo de failover da instância com os parâmetros especificados ou atualiza as propriedades ou marcas para o grupo de failover da instância especificada. |
> | Ação | Microsoft.Sql/locations/instancePoolAzureAsyncOperation/read | Obtém o status de uma operação de pool de instância |
> | Ação | Microsoft.Sql/locations/instancePoolOperationResults/read | Obtém o resultado de uma operação de pool de instância |
...
> | Ação | Microsoft.Sql/locations/managedInstanceEncryptionProtectorAzureAsyncOperation/read | Obtém de operações em um protetor de criptografia de instância gerenciada de criptografia transparente de dados em andamento |
> | Ação | Microsoft.Sql/locations/managedInstanceEncryptionProtectorOperationResults/read | Obtém de operações em um protetor de criptografia de instância gerenciada de criptografia transparente de dados em andamento |
> | Ação | Microsoft.Sql/locations/managedInstanceKeyAzureAsyncOperation/read | Obtém as operações de em andamento na criptografia transparente de dados gerenciados chaves de instância |
> | Ação | Microsoft.Sql/locations/managedInstanceKeyOperationResults/read | Obtém as operações de em andamento na criptografia transparente de dados gerenciados chaves de instância |
...
> | Ação | Microsoft.Sql/locations/privateEndpointConnectionAzureAsyncOperation/read | Obtém o resultado de uma operação de conexão do ponto de extremidade privado |
> | Ação | Microsoft.Sql/locations/privateEndpointConnectionOperationResults/read | Obtém o resultado de uma operação de conexão do ponto de extremidade privado |
> | Ação | Microsoft.Sql/locations/privateEndpointConnectionProxyAzureAsyncOperation/read | Obtém o resultado de uma operação de proxy de conexão do ponto de extremidade privado |
> | Ação | Microsoft.Sql/locations/privateEndpointConnectionProxyOperationResults/read | Obtém o resultado de uma operação de proxy de conexão do ponto de extremidade privado |
> | Ação | Microsoft.Sql/locations/read | Obter os locais disponíveis para uma determinada assinatura |
> | Ação | Microsoft.Sql/locations/serverKeyAzureAsyncOperation/read | Obtém de operações em chaves de servidor de criptografia transparente de dados em andamento |
> | Ação | Microsoft.Sql/locations/serverKeyOperationResults/read | Obtém de operações em chaves de servidor de criptografia transparente de dados em andamento |
...
> | Ação | Microsoft.Sql/managedInstances/databases/currentSensitivityLabels/write | Rótulos de confidencialidade de atualização em lotes |
...
> | Ação | Microsoft.Sql/managedInstances/databases/schemas/read | Obter um esquema de banco de dados gerenciado. |
> | Ação | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/read | Obtenha uma coluna de banco de dados gerenciado |
...
> | Ação | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/sensitivityLabels/disable/action | Desativar as recomendações de confidencialidade em uma determinada coluna |
> | Ação | Microsoft.Sql/managedInstances/databases/schemas/tables/columns/sensitivityLabels/enable/action | Habilitar as recomendações de confidencialidade em uma determinada coluna |
...
> | Ação | Microsoft.Sql/managedInstances/databases/securityAlertPolicies/read | Recuperar uma lista de políticas de detecção de ameaças do banco de dados gerenciado configurado para um determinado servidor |
...
> | Ação | Microsoft.Sql/managedInstances/securityAlertPolicies/read | Recuperar uma lista de políticas de detecção de ameaças do servidor gerenciado configurada para um determinado servidor |
...
> | Ação | Microsoft.Sql/servers/databases/currentSensitivityLabels/write | Rótulos de confidencialidade de atualização em lotes |
...
> | Ação | Microsoft.Sql/servers/databases/failover/action | Failover de banco de dados iniciada pelo cliente. |
...
> | Ação | Microsoft.Sql/servers/databases/move/action | Altere o nome do banco de dados existente. |
...
> | Ação | Microsoft.Sql/servers/databases/schemas/tables/columns/read | Obtenha uma coluna de banco de dados. |
...
> | Ação | Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels/disable/action | Desativar as recomendações de confidencialidade em uma determinada coluna |
> | Ação | Microsoft.Sql/servers/databases/schemas/tables/columns/sensitivityLabels/enable/action | Habilitar as recomendações de confidencialidade em uma determinada coluna |
...
> | Ação | Microsoft.Sql/servers/databases/schemas/tables/read | Obtém uma tabela de banco de dados. |
...
> | Ação | Microsoft.Sql/servers/databases/securityAlertPolicies/read | Recuperar uma lista de políticas de detecção de ameaças do banco de dados configurado para um determinado servidor |
...
> | Ação | Microsoft.Sql/servers/elasticPools/failover/action | Cliente iniciado pelo failover do pool Elástico. |
...
> | Ação | Microsoft.Sql/servers/privateEndpointConnectionProxies/delete | Exclui um proxy de conexão do ponto de extremidade privado existente |
> | Ação | Microsoft.Sql/servers/privateEndpointConnectionProxies/read | Retorna a lista de pontos de extremidade privados proxies de conexão ou obtém as propriedades para o proxy de conexão privada do ponto de extremidade especificado. |
> | Ação | Microsoft.Sql/servers/privateEndpointConnectionProxies/validate/action | Valida uma privada conexão de ponto de extremidade criar chamada do lado NRP |
> | Ação | Microsoft.Sql/servers/privateEndpointConnectionProxies/write | Cria um proxy de conexão do ponto de extremidade privado com os parâmetros especificados ou atualiza as propriedades ou marcas para o proxy de conexão privada do ponto de extremidade especificado. |
> | Ação | Microsoft.Sql/servers/privateEndpointConnections/delete | Exclui uma conexão privada do ponto de extremidade existente |
> | Ação | Microsoft.Sql/servers/privateEndpointConnections/read | Retorna a lista de conexões de ponto de extremidade privado ou obtém as propriedades para a conexão privada do ponto de extremidade especificado. |
> | Ação | Microsoft.Sql/servers/privateEndpointConnections/write | Aprova ou rejeita uma conexão privada do ponto de extremidade existente |
> | Ação | Microsoft.Sql/servers/privateLinkResources/read | Obtenha os recursos de link privado para o sql server correspondente |
...
> | Ação | Microsoft.Sql/servers/securityAlertPolicies/read | Recuperar uma lista de políticas de detecção de ameaças do servidor configurado para um determinado servidor |
...
> | Ação | Microsoft.Storage/storageAccounts/failover/action | O cliente é capaz de controlar o failover no caso de problemas de disponibilidade |
...
> | Ação | Microsoft.Storage/storageAccounts/fileServices/read | Obter as propriedades do serviço arquivo |
...
> | Ação | Microsoft.Storage/storageAccounts/managementPolicies/delete | Excluir as políticas de gerenciamento da conta de armazenamento |
> | Ação | Microsoft.Storage/storageAccounts/managementPolicies/read | Obter políticas da conta de gerenciamento de armazenamento |
> | Ação | Microsoft.Storage/storageAccounts/managementPolicies/write | Empregar políticas de gerenciamento de conta de armazenamento |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/delete | Excluir Proxies de Conexão do ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/validate/action | Validar Proxies de Conexão do ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnectionProxies/write | Colocar os Proxies de Conexão do ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/delete | Excluir Conexão de ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/read | Obter Conexão do ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateEndpointConnections/write | Coloque a Conexão de ponto de extremidade privados |
> | Ação | Microsoft.Storage/storageAccounts/privateLinkResources/read | Obter IDs de grupo StorageAccount |
...
> | Ação | Microsoft.Storage/storageAccounts/restoreBlobRanges/action | Restaurar blob intervalos para o estado de tempo especificado |
...
> | Ação | Microsoft.Storage/storageAccounts/tableServices/read | Obter as propriedades do serviço Tabela |
...
> | Ação | Microsoft.Web/hostingEnvironments/Join/Action | Ingressa em um ambiente do serviço de aplicativo |
...
> | Ação | Microsoft.Web/hostingEnvironments/PrivateEndpointConnectionsApproval/action | Aprovar as conexões de ponto de extremidade privados |
...
> | Ação | microsoft.web/sites/networktraces/operationresults/read | Obter resultados de operação de rastreamento de rede de aplicativos Web. |
...
> | Ação | Microsoft.Web/sites/PrivateEndpointConnectionsApproval/action | Aprovar as conexões de ponto de extremidade privados |
> | Ação | microsoft.web/sites/processes/modules/read | Obter os módulos de processos de aplicativos Web. |
> | Ação | microsoft.web/sites/processes/read | Obter processos de Aplicativos Web. |
> | Ação | microsoft.web/sites/processes/threads/read | Obtenha os Threads de processos de aplicativos Web. |
...
> | Ação | microsoft.web/sites/slots/networktraces/operationresults/read | Obter resultados de operação de rastreamento de rede de Slots de aplicativos de Web. |
