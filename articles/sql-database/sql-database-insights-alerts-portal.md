...
2. Selecione **Alertas (Clássicos)** na seção MONITORAMENTO. O texto e o ícone podem variar um pouco para recursos diferentes.  
     ...
     ![Monitorando](media/sql-database-insights-alerts-portal/AlertsClassicButton.JPG)
...
7. Se você quiser que outros emails recebam uma notificação quando o alerta for disparado, adicione-os ao campo **Email(s) de administrador adicionais** . Separe vários emails com ponto e vírgula – *envie\@um email para contoso.\@com; EMAIL2 contoso.com*
...
| --- | --- | --- | --- | --- |
| Banco de dados SQL | cpu_percent | Percentual de CPU | Average | 5 minutos |
| Banco de dados SQL | physical_data_read_percent | Porcentagem de E/S de dados | Average | 5 minutos |
| Banco de dados SQL | log_write_percent | Porcentagem de E/S de log | Average | 5 minutos |
| Banco de dados SQL | dtu_consumption_percent | Porcentual de DTU | Average | 5 minutos |
...
| Banco de dados SQL | blocked_by_firewall | Bloqueado por Firewall | Total | 10 minutos |
...
| Banco de dados SQL | xtp_storage_percent | Percentual (Visualização) de armazenamento do OLTP na memória | Average | 5 minutos |
| Banco de dados SQL | workers_percent | Porcentagem de funcionários | Average | 5 minutos |
| Banco de dados SQL | sessions_percent | Porcentagem de sessões | Average | 5 minutos |
| Banco de dados SQL | dtu_limit | Limite de DTU | Average | 5 minutos |
| Banco de dados SQL | dtu_used | DTU usado | Average | 5 minutos |
||||||
| Pool elástico | cpu_percent | Percentual de CPU | Average | 10 minutos |
| Pool elástico | physical_data_read_percent | Porcentagem de E/S de dados | Average | 10 minutos |
| Pool elástico | log_write_percent | Porcentagem de E/S de log | Average | 10 minutos |
| Pool elástico | dtu_consumption_percent | Porcentual de DTU | Average | 10 minutos |
| Pool elástico | storage_percent | Porcentagem de armazenamento | Average | 10 minutos |
| Pool elástico | workers_percent | Porcentagem de funcionários | Average | 10 minutos |
| Pool elástico | eDTU_limit | Limite de eDTU | Average | 10 minutos |
| Pool elástico | storage_limit | Limite de armazenamento | Average | 10 minutos |
| Pool elástico | eDTU_used | eDTU usado | Average | 10 minutos |
| Pool elástico | storage_used | Armazenamento usado | Average | 10 minutos |
||||||               
| SQL data warehouse | cpu_percent | Percentual de CPU | Average | 10 minutos |
| SQL data warehouse | physical_data_read_percent | Porcentagem de E/S de dados | Average | 10 minutos |
...
| SQL data warehouse | blocked_by_firewall | Bloqueado por Firewall | Total | 10 minutos |
