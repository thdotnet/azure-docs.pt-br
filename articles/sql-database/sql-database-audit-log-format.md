...
| foi bem-sucedida | succeeded_s | Indica se a ação que acionou o evento foi bem-sucedida. Para eventos diferentes de lote e de logon, reporta somente se a verificação de permissão foi bem-sucedida ou falha, não a operação. 1 = êxito, 0 = falha | bit | cadeia de caracteres |
