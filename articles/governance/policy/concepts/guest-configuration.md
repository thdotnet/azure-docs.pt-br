...
> [!NOTE]
> O **DeployIfNotExists** diretiva é necessária para o **auditoria** política para retornar resultados.
> Sem o **DeployIfNotExists**, o **auditoria** política mostra "0 0" recursos como o status.
