...
Quando você move um grupo de gerenciamento pai, a hierarquia de grupo será movido com ele. Para obter acesso, você precisa mover grupos de gerenciamento, consulte [acesso de grupo de gerenciamento](index.md#management-group-access).
