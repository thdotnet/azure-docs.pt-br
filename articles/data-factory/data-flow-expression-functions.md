...
Adiciona dias a uma data ou carimbo de data/hora. O mesmo que o operador + para data* ``addDays(toDate('2016-08-08'), 1) -> 2016-08-09``
___
### <code>addMonths</code>
...
Com base em condições alternadas, aplica-se um valor ou o outro. Se o número de entradas for par, o outro será nulo para a última condição* ``case(custType == 'Premium', 10, 4.5)``
...
Concatena um número variável de cadeias de caracteres juntas. O mesmo que o operador + com cadeias de caracteres* ``concat('Awesome', 'Cool', 'Product') -> 'AwesomeCoolProduct'``
...
Obtém a contagem agregada de valores. Se a coluna (s) opcional for especificada, ela ignorará valores nulos na contagem* ``count(custId) -> 100``
...
Calcula o hash CRC32 do conjunto de colunas de diferentes tipos de dados primitivos dado um comprimento de bits, que pode ser apenas de valores 0 (256), 224, 256, 384, 512. Ele pode ser usado para calcular uma impressão digital de uma linha* ``crc32(256, 'gunchus', 8.2, 'bojjus', true, toDate('2010-4-4')) -> 3630253689``
___
### <code>cumeDist</code>
...
Obtém o carimbo de data/hora atual como UTC. Você pode passar um fuso horário opcional na forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. Ele é padronizado para o fuso horário atual* ``currentUTC() -> 12-12-2030T19:18:12``
...
Sempre retorna um valor false. Use a sintaxe da função (false ()) se houver uma coluna chamada ' false '* ``isDiscounted == false()``
* ``isDiscounted() == false``
___
### <code>first</code>
...
Operador de comparação greater than or equal. Mesmo que > = Operator* ``greaterOrEqual(12, 12) -> false``
* ``'abcd' >= 'abc' -> true``
___
### <code>greatest</code>
<code><b>greatest(<i>&lt;value1&gt;</i> : any, ...) => any</b></code><br/><br/>
Retorna o maior valor entre a lista de valores como entrada. Retornará NULL se todas as entradas forem nulas* ``greatest(10, 30, 15, 20) -> 30``
...
Com base em uma condição, aplica-se um valor ou o outro. Se outro não for especificado, ele será considerado nulo. Ambos os valores devem ser compatíveis (Numeric, String...)* ``iif(custType == 'Premium', 10, 4.5)``
* ``iif(amount > 100, 'High')``
...
Localiza a posição (baseada em 1) da subcadeia de caracteres dentro de uma cadeia de caracteres. 0 será retornado se não for encontrado* ``instr('great', 'eat') -> 3``
* ``instr('microsoft', 'o') -> 7``
* ``instr('good', 'bad') -> 0``
___
### <code>isDelete</code>
...
Obtém o valor do primeiro parâmetro avaliado n linhas depois da linha atual. O segundo parâmetro é o número de linhas a serem examinadas e o valor padrão é 1. Se não houver tantas linhas, um valor de NULL será retornado, a menos que um valor padrão seja especificado* ``lead(amount, 2) -> 60``
...
Localiza a posição (baseada em 1) da subcadeia de caracteres dentro de uma cadeia de caracteres começando de uma certa posição. Se a posição for omitida, será considerada desde o começo da cadeia de caracteres. 0 será retornado se não for encontrado* ``locate('eat', 'great') -> 3``
...
Preenche à esquerda a cadeia de caracteres com o preenchimento fornecido até que esta alcance um determinado comprimento. Se a cadeia de caracteres for igual ou maior que o comprimento, ela será considerada um ' ' LPAD * ``lpad('great', 10, '-') -> '___--great'`` ' de não op 
* ``lpad('great', 4, '-') -> 'great'`` 
* (' Great ', 8, ' < > ')-> ' <<great'``
___
### <code>> LTrim</code>
<code><b>ltrim(<i>&lt;string to trim&gt;</i> : string, <i>&lt;trim characters&gt;</i> : string) => string</b></code><br/><br/>
Corta uma cadeia de caracteres inicial à esquerda. Se o segundo parâmetro não for especificado, ele cortará o espaço em branco. Caso contrário, ele apara qualquer caractere especificado no segundo parâmetro* ``ltrim('!--!wor!ld!', '-!') -> 'wor!ld!'``
___
### <code>max</code>
...
Calcula o digest MD5 do conjunto de colunas de diferentes tipos de dados primitivos e retorna uma cadeia hexadecimal de 32 caracteres. Ele pode ser usado para calcular uma impressão digital de uma linha* ``md5(5, 'gunchus', 8.2, 'bojjus', true, toDate('2010-4-4')) -> 'c1527622a922c83665e49835e46350fe'``
___
### <code>mean</code>
<code><b>mean(<i>&lt;value1&gt;</i> : number) => number</b></code><br/><br/>
Obtém a média dos valores de uma coluna. Igual ao AVG* ``mean(sales) -> 7523420.234``
___
### <code>meanIf</code>
<code><b>meanIf(<i>&lt;value1&gt;</i> : boolean, <i>&lt;value2&gt;</i> : number) => number</b></code><br/><br/>
Com base em um critério, obtém a média dos valores de uma coluna. O mesmo que avgIf* ``meanIf(region == 'West', sales) -> 7523420.234``
___
...
Obtém o número de meses entre dois datesYou pode passar um fuso horário opcional na forma de ' GMT ', ' PST ', ' UTC ', ' América/Cayman '. O fuso horário local é usado como padrão.
...
Preenche à direita a cadeia de caracteres com o preenchimento fornecido até que esta alcance um determinado comprimento. Se a cadeia de caracteres for igual ou maior que o comprimento, ela será considerada um RTRIM não op * ``rpad('great', 10, '-') -> 'great___--'`` 
* ``rpad('great', 4, '-') -> 'great'`` 
* ``rpad('great', 8, '<>') -> 'great<><'`` 
___
### <code>rtrim</code></code>
<code><b>rtrim(<i>&lt;string to trim&gt;</i> : string, <i>&lt;trim characters&gt;</i> : string) => string</b></code><br/><br/>
Corta uma cadeia de caracteres final à direita. Se o segundo parâmetro não for especificado, ele cortará o espaço em branco. Caso contrário, ele apara qualquer caractere especificado no segundo parâmetro* ``rtrim('!--!wor!ld!', '-!') -> '!--!wor!ld'``
___
### <code>second</code>
...
Calcula o digest SHA-1 do conjunto de colunas de diferentes tipos de dados primitivos e retorna uma cadeia hexadecimal de 40 caracteres. Ele pode ser usado para calcular uma impressão digital de uma linha* ``sha1(5, 'gunchus', 8.2, 'bojjus', true, toDate('2010-4-4')) -> '63849fd2abb65fbc626c60b1f827bd05573f0cea'``
___
### <code>sha2</code>
...
Subtrai meses a partir de uma data. O mesmo que o-Operator para data* ``subDays(toDate('2016-08-08'), 1) -> 2016-08-09``
___
### <code>subMonths</code>
...
Converte uma cadeia de caracteres em uma data de acordo com um formato de data opcional. Consulte Java SimpleDateFormat para todos os formatos possíveis. Se o formato de data for omitido, combinações dos itens a seguir serão aceitas. [yyyy, aaaa-[M] M, aaaa-[M] M-[d] d, YYYY-[M] M-[d] d, YYYY-[M] M-[d] d, YYYY-[M] M-[d] dT *]* ``toDate('2012-8-8') -> 2012-8-8``
...
Converte qualquer numérico ou cadeia de caracteres em um valor flutuante. Um formato decimal opcional do Java pode ser usado para a conversão. Trunca qualquer duplo* ``toFloat(123.45) -> 123.45``
...
Converte uma cadeia de caracteres em uma data com um determinado formato de carimbo de data/hora opcional. Consulte Java SimpleDateFormat para todos os formatos possíveis. Se o carimbo de data/hora for omitido, o padrão aaaa-[M] M-[d] d hh: mm: SS [. f...] será usado* ``toTimestamp('2016-12-31 00:12:00') -> 2012-8-8T00:12:00``
* ``toTimestamp('2016/12/31T00:12:00', 'MM/dd/yyyyThh:mm:ss') -> 2012-12-12T00:12:00``
___
### <code>toUTC</code>
<code><b>toUTC(<i>&lt;value1&gt;</i> : timestamp, [<i>&lt;value2&gt;</i> : string]) => timestamp</b></code><br/><br/>
Converte o carimbo de data/hora em UTC. Você pode passar um fuso horário opcional na forma de 'GMT', 'PST', 'UTC', 'America/Cayman'. Ele é padronizado para o fuso horário atual* ``toUTC(currentTimeStamp()) -> 12-12-2030T19:18:12``
* ``toUTC(currentTimeStamp(), 'Asia/Seoul') -> 12-13-2030T11:18:12``
___
### <code>translate</code>
<code><b>translate(<i>&lt;string to translate&gt;</i> : string, <i>&lt;lookup characters&gt;</i> : string, <i>&lt;replace characters&gt;</i> : string) => string</b></code><br/><br/>
Substitui um conjunto de caracteres por outro conjunto de caracteres na cadeia de caracteres. Os caracteres têm de 1 a 1 substituição* ``translate('(Hello)', '()', '[]') -> '[Hello]'``
* ``translate('(Hello)', '()', '[') -> '[Hello'``
___
### <code>trim</code>
<code><b>trim(<i>&lt;string to trim&gt;</i> : string, [<i>&lt;trim characters&gt;</i> : string]) => string</b></code><br/><br/>
Apara uma cadeia de caracteres inicial e final. Se o segundo parâmetro não for especificado, ele cortará o espaço em branco. Caso contrário, ele apara qualquer caractere especificado no segundo parâmetro* ``trim('!--!wor!ld!', '-!') -> 'wor!ld'``
___
### <code>true</code>
<code><b>true() => boolean</b></code><br/><br/>
Sempre retorna um valor true. Use a sintaxe da função (true ()) se houver uma coluna chamada ' true '* ``isDiscounted == true()``
* ``isDiscounted() == true``
___
### <code>typeMatch</code>
