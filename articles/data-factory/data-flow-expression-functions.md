...
Preenche à esquerda a cadeia de caracteres com o preenchimento fornecido até que esta alcance um determinado comprimento. Se a cadeia de caracteres for igual ou maior que o comprimento, ela será considerada um ' ' LPAD * ``lpad('great', 10, '-') -> '-----great'`` ' de não op 
* ``lpad('great', 4, '-') -> 'great'`` 
* (' Great ', 8, ' < > ')-> ' <<great'``
---
### <code>> LTrim</code>
...
Preenche à direita a cadeia de caracteres com o preenchimento fornecido até que esta alcance um determinado comprimento. Se a cadeia de caracteres for igual ou maior que o comprimento, ela será considerada um RTRIM não op * ``rpad('great', 10, '-') -> 'great-----'`` 
* ``rpad('great', 4, '-') -> 'great'`` 
* ``rpad('great', 8, '<>') -> 'great<><'`` 
---
