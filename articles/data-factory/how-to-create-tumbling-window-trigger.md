...
| **depende: tamanho** | O tamanho da janela de dependência em cascata. | Intervalo de tempo<br/>(hh:mm:ss)  | Um valor de TimeSpan positivo em que o padrão é o tamanho da janela do gatilho filho  | Não |
| **depende: deslocamento** | O deslocamento do gatilho de dependência. | Intervalo de tempo<br/>(hh:mm:ss) |  Um valor TimeSpan que deve ser negativo em uma autodependência. Se nenhum valor for especificado, a janela será igual ao próprio gatilho. | Autodependência: Sim<br/>Outros: Não  |
