...
- Se você precisar colocar um IP ou intervalo de IP de proteção do Azure contra DDoS Standard. Um cenário comum é a lista branca IP, se o tráfego é roteado de uma nuvem externa WAF para o Azure. 
