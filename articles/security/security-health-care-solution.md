...
[Guia prático para criar soluções de serviços médicos seguras no Microsoft Azure](https://aka.ms/azureindustrysecurity) o ajuda a entender como você pode aumentar a segurança de suas soluções usando os serviços e recursos do Azure que pode configurar com base em seus requisitos.
O conteúdo é dividido em três seções principais:
