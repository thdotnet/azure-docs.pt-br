...
![Evento XML](media/azure-log-integration-faq/event-xml.png)
...
* [Operações de auditoria com o Azure Resource Manager](/azure/azure-resource-manager/resource-group-audit)
...
Confira [Gerenciando e respondendo a alertas de segurança na Central de Segurança do Azure](/azure/security-center/security-center-managing-and-responding-alerts).
...
Se você tiver problemas durante a instalação e configuração, abra uma [solicitação de suporte](/azure/azure-supportability/how-to-create-azure-support-request). Selecione **Integração de Log** como o serviço para o qual você está solicitando suporte.
