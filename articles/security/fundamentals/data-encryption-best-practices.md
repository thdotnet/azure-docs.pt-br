...
**Detalhe**: Use [ExpressRoute](/azure/expressroute/expressroute-introduction). Se você optar por usar o ExpressRoute, também poderá criptografar os dados no nível do aplicativo usando [SSL/TLS](https://support.microsoft.com/kb/257591) ou outros protocolos para proteção adicional.

**Melhor prática**: Interagir com o Armazenamento do Azure por meio do portal do Azure.   
**Detalhe**: Todas as transações ocorrerão via HTTPS. Você também pode usar a [API REST de armazenamento](https://msdn.microsoft.com/library/azure/dd179355.aspx) sobre HTTPS para interagir com o [armazenamento do Azure](https://azure.microsoft.com/services/storage/).
