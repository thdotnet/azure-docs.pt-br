...
Para nos ajudar a priorizar os recursos e novas regiões, preencha este [survey](https://aka.ms/azurefilesatscalesurvey).

### <a name="steps-to-onboard"></a>Etapas para integrar

Para registrar sua assinatura para a visualização de compartilhamentos de arquivos maior, você precisa usar o Azure PowerShell. Você pode usar [Azure Cloud Shell](https://shell.azure.com/) ou instale o [módulo do PowerShell do Azure localmente](https://docs.microsoft.com/powershell/azure/install-Az-ps?view=azps-2.4.0) para executar os seguintes comandos do PowerShell:

Primeiro, verifique se a assinatura que você deseja inscrever-se na visualização está selecionada:
...
Em seguida, registre a visualização usando os comandos a seguir:
