...
| RHEL | 7+ | 7.5+ |
| CentOS | 7+ |  7.5+ |
| Debian | 8+ | mais de 9<sup>*</sup> |
| openSUSE | 13.2+ | 42.3+ |
| SUSE Linux Enterprise Server | 12 | 12 SP3+ |

<sup>*</sup>O uso de um kernel reportado pode ser necessário. Você pode instalá-la com `sudo apt-get install linux-image-cloud-amd64`.
