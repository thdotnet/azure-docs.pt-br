...
**Causa:** A assinatura que você está usando é um tipo que não é possível acessar os recursos necessários na região em que o cliente está tentando implantar. Por exemplo, as assinaturas do MSDN, gratuito ou educação podem mostrar esse erro.

**Correção:** Altere seu tipo de assinatura ou região para que possa acessar os recursos necessários.
