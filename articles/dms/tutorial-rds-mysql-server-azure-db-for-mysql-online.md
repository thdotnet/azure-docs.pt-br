...
* Abra o Firewall do Windows para permitir que o Serviço de Migração de Banco de Dados do Azure acesse o servidor MySQL de origem (a porta TCP padrão é a 3306).
