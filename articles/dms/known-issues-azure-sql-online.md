...
Se precisar que o DMS migre o valor de carimbo de data/hora exato armazenado na tabela de origem, entre em contato com a equipe de engenharia em [solicitar migrações de banco de dados do Azure](mailto:AskAzureDatabaseMigrations@service.microsoft.com).
