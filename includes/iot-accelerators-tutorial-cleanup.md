...
[![Pausar telemetria](./media/iot-accelerators-tutorial-cleanup/togglesimulation-inline.png)](./media/iot-accelerators-tutorial-cleanup/togglesimulation-expanded.png#lightbox)
...
![Excluir solução](media/iot-accelerators-tutorial-cleanup/deletesolution.png)

![Excluir solução](media/iot-accelerators-tutorial-cleanup/deletesolution-provision.png)