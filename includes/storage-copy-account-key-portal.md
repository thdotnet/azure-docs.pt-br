...
3. Na seção **Configurações** da visão geral da conta de armazenamento, selecione **Chaves de acesso**. Suas chaves de acesso da conta e a cadeia de conexão são exibidas.
4. Anote o nome da sua conta de armazenamento, pois você precisará dela para a autorização.   
