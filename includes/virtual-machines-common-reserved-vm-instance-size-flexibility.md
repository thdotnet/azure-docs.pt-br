...
Para obter mais informações, consulte [Tamanhos de máquinas virtuais otimizados para armazenamento](../articles/virtual-machines/windows//sizes-storage.md#lsv2-series).
...
## <a name="ms-series-fractional-tiny"></a>Série MS Fracionária Minúscula
