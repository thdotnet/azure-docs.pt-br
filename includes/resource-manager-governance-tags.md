...
* As máquinas virtuais e conjuntos de dimensionamento de máquina Virtual são limitados a um total de 2048 caracteres para todos os valores e nomes de marca. Não generalizadas não dão suporte a marcas.
