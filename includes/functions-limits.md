...
| --- | --- | --- | --- |
| Escalar horizontalmente | Controlado por evento | Controlado por evento | [Manual/dimensionamento automático](../articles/app-service/web-sites-scale.md) | 
